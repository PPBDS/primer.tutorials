...
*NOTE*: library(primer.tutorials) is always included in initial code chunk. This library is necessary so the students can submit their work. Additionally, you may need to add packages which are used in your tutorial. All the tutorials need the tidyverse.
