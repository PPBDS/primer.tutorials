...
Each section begins with a few sentences which explain what this collection of exercises will teach us. Or it can "drop" some knowledge. But anything more than a short paragraph is much too much. Students won't read it. The portion is followed by with a triple hash on its own line. 
...
This creates a "Continue" button  which students will have to click before they get to see the first exercise.


Each exercise should have a "flow" which requires that students hit the "Continue" button at least twice, and potentially more. 

* Each exercise because with a sentence or two of knowledge and/or the question itself. But that is all we show the student. We do not show the exercise code chunk. Instead, the intro is followed 
