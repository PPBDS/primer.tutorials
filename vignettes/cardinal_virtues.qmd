...
Who am I and what problem and I trying to solve?
...
> *What explains individual voting decisions on the 1992 US Presidential election?*
...
The relationship between `plot_predictions()` and `plot_comparisons()` is subtle, but the central point is that, if want to look at the difference or ratio or any other function of more than one expected value, you must use `plot_comparisons()`.
