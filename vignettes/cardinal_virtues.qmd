...
The covariate/treatment is the variable in which we are most interested, the one whose connection, if any, to the outcome is at center of our project. If our task is mere prediction, then there may not be a central covariate of interest. If the model is causal, then the treatment is almost certainly the most important covariate.
