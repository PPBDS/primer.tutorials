...
Of course, you need a proper code chunk for this to work. `include_graphics()` is part of the `knitr` package, so you need `library(knitr)` in the setup code chunk. And
