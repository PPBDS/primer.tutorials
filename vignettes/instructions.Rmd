...
```{r, echo = FALSE, out.width = "75%", out.height = "75%"}
knitr::include_graphics("images/question-exercise-w-answer.png")
```

Written Exercise without Answer:

```{r, echo = FALSE, out.width = "75%", out.height = "75%"}
knitr::include_graphics("images/question-exercise-no-answer.png")
```
...
Limitations:
- It doesn't work well with the \`r''\`
