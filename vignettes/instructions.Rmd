...
Each Section is composed of a series of numbered Exercises. To create the exercise headers, you use three hashes. Make sure you number your exercises -- `### Exercise 1`, `### Exercise 2` and so on. This makes it easy for students to refer to a specific location when they have a question. 
...
No aspect of the tutorials has given us more trouble than permanent objects. 
