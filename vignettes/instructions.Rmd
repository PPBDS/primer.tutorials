...
We can only demonstrate a tiny percentage of all the packages in the world, but we can certainly at least mention the existence of dozens more. Within the packages we use, we can only demonstrate a handful of the functions, but we can mention many more. Among the functions we use, we can only demonstrate some of the arguments, but we can mention others. 
