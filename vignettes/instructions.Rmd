...
You can find the addins in the "Addins" tab on the top toolbar of RStudio. Please make sure that your cursor is at where you want to insert it in the document. You may need to "Install and Restart" the *all.primer.tutorials* package for the Addins to appear.
