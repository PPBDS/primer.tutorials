...
<!-- If you want to use an image on a tutorial, create a `images` folder in the folder in which the `tutorial.Rmd` file is located. Then, you can use our usual trick of  -->
