...
* Default value for the `"Time/Year"` column in the Preceptor Table.
* Typically a 4-digit year (e.g., `"2022"`) or full date if desired.
* Meant to communicate **when the expectations were formed**, not when the outcome occurred.
