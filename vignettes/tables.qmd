...
### `covariate_1_label`, `covariate_2_label`, `covariate_3_label` *(Characters)*

* Labels for three covariates relevant to the analysis.
...
p_tibble <- tibble::tribble(
 ...
 "John Smith",   "2025", "?", "Not Re-elected", "Yes", "Male", "58", "Incumbent", "...",
  "Jane Doe",     "2025", "?", "Not Re-elected", "No",  "Female", "49", "Challenger", "...",
  "...", "...", "...", "...", "...", "...", "...", "...", "...", "...",
  "Chris Lee",    "2025", "Re-elected", "?", "No",  "Male", "55", "Incumbent", "...",
  "...", "...", "...", "...", "...", "...", "...", "...", "..."
)
```
...
d_tibble <- tibble::tribble(
  ...
  "...", "...", "...", "...", "...", "...", "...", "...", "...", "...",
  "Data", "Mary Jackson",   "2021", "Re-elected", "---", "Yes", "Female", "51", "Incumbent", "...",
  "Data", "Alex Johnson",     "2022", "---", "Not Re-elected", "Yes", "Male", "46", "Challenger", "...",
  "...", "...", "...", "...", "...", "...", "...", "...", "...", "...",
  "Data", "Bobby Norris",    "2022", "Re-elected", "---", "No", "Male", "63", "Challenger", "...",
  "...", "...", "...", "...", "...", "...", "...", "...", "...", "...",
  # Add Preceptor rows
  "Preceptor Table", "John Smith",   "2025", "?", "Not Re-elected", "Yes", "Male", "58", "Incumbent", "...",
  "Preceptor Table", "Jane Doe",     "2025", "?", "Not Re-elected", "No",  "Female", "49", "Challenger", "...",
  "...", "...", "...", "...", "...", "...", "...", "...", "...", "...",
  "Preceptor Table", "Chris Lee",    "2025", "Re-elected", "?", "No",  "Male", "55", "Incumbent", "...",
  "...", "...", "...", "...", "...", "...", "...", "...", "...", "..."
)
```
