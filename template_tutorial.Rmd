...
The question can not specify values for more than one covariate, simply because you do not know which covariates will be included in the model until you create it. You must mention the covariate (i.e., the treatment) in a causal model. Also, t is not unreasonable to specify, before you start, a covariate whose connection, if any, to the outcome is of special interest.
