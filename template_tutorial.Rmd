...
<!-- How do we organize the Wisdom section? Right now, we mix up EDA and Preceptor Table. But, instead, we could make the back and forth more explicit. First, figure out the ideal Preceptor Table. Then, look at the data. Then, define a new Preceptor Table which is close enough to the data that validity probably holds. Perhaps THE ENTIRE THE QUESTION TOPIC have nothing to do with the actual data. It is only the Preceptor Table we want. Then Wisdom starts with the question and this ideal Precpetor Table. Then looks at the data. Then changes the Preceptor Table. -->
