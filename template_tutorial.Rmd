...
<!-- DK: Should the default be to use newdata = "balanced"? Or maybe we don't introduce that till later tutorials. Or maybe we don't introduce ndata till later tutorials? -->
