...
<!-- Data changing does not necessarily violate stability. -->

<!-- Representativeness problems are easy to state. The knowledge drop then explains how that problem, if true, might lead to biased parameter estimates. -->
...
<!-- ``` -->
<!-- XX: -->
<!-- Give them the math within these triple backticks so that they can just copy and paste it into their QMD. Use double dollar signs so that each formula is on its own line. Example: -->
<!-- $$ att\_end_i \sim Normal(\mu)$$ -->
<!-- $$ \mu =  \beta_0 + \beta_1 x_1 + \dots $$ -->
<!-- ``` -->
