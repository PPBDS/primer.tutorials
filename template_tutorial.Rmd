...
Because `plot_predictions()` returns a ggplot object, you can just continue with ggplot commands like `labs()`. However, it can be useful to see the actual underlying values in the tibble and then build your own plot directlt from them.
