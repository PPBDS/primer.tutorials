...
# XX: You need (?) library(knitr) if you want to include any graphics in the tutorial.
...
Finalize the new graphics code chunk in your QMD. `Command/Ctrl + Shift + K` to ensure that it all works as intended. 
