...
<!-- XX: Provide an intelligent discussion of the results. Conclude that, while not perfect, the model is probably good enough. Or! Note that it is not good enough, and go create a new model, and then check it. Then note how much better it is. And then make that new fitted object the one we use going formward. -->
