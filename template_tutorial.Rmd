...
<!-- Add a new question after check_predictions() which shows the plot and then asks for a two sentence interpretation. -->
...
<!-- Mention assignment mechanism and selection mechanism. -->

<!-- Discuss  draw = FALSE) -->

<!-- In marginaleffects, explain taking the average of the ratios (or whatever) versus the ratio of the averages. -->

<!-- Add specific questions using marginaleffects functions. First is always predictions(). -->

<!-- Second is always (?) avg_comparisons()? -->
...
<!-- In the Temperance questions using marginaleffects should have a bunch of default knowledge drops about what the model means, what the `by` argument does, and so on. This would parallel the knowledge drops we provide for the coefficient interpretation questions. The first question is always predictions(), and then a knowledge drop about how we are using the DGM. -->
