...
Because our outcome variable is [XX: binary or continuous or multinomial], start to create the model by using `[XX: logistic_reg() or linear_reg() or multinom_reg()]`.
...
```
tutorial.helpers::show_file("XX.qmd", start = -4)
```
