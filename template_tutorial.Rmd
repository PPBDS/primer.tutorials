...
# objects using that package work with our usual tools. In general, gtsummary
# works with everything and marginaleffects is also ecumenical. 
...
<!-- Consider plugging in examples from Tutorial 6. -->
...
Edit the `.gitignore` by adding `XX_files`. Save and push.
...
<!-- XX: Discuss how the outcome variable that we really care about is almost never the outcome variable which our data might shed light on. Finish with: This compromise --- working with what we have rather than what we *really* want is a part of most data science work in the real world.-->
...
Also, what is the best way to perform posterior predictive checks?
...
```
tutorial.helpers::show_file("XX.qmd", pattern = "tidymodels|gtsummary|marginaleffects")
```
