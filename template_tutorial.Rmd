...
author: XX
tutorial:
  id: XX (should be the number + title, everything in lower case, all spaces and weird characters replaced with dashes. See Instructions for details.)
output:
  learnr::tutorial:
    progressive: yes
    'allow_skip:': yes
...
<!-- The Wisdom introduction is this section. It always includes a quote. Then it asks the general question, indented and italized. Then it asks the specific question, also indented and italized. This is exactly the way the Primer works. There might also be some explanatory sentences around that, and the use of triple hashes to force a "Continue" button. If this is unclear, you need to read https://ppbds.github.io/primer/key-concepts.html closely. -->
...
It is always a good idea to knowledge drop a link to the actual data and to any articles/websites related to it.

You won't be drawing any conclusions or discussing the explicit violation of any assumptions. That discussion is saved until Justice and the specific questions about stability, representativeness, and (with causal models) unconfoundedness. You are, howoever, providing the details which you and the students can then use later. -->
