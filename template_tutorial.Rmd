...
```{r wisdom-1}
question_text(NULL,
    message = "Wisdom requires the creation of a Preceptor Table and an examination of our data.",
    answer(NULL, correct = TRUE),
    allow_retry = FALSE,
    incorrect = NULL,
    rows = 3)
...
<!-- DK: Revisit the order of these questions. -->
...
<!-- DK: Some of these could go in the Introduction. -->
