...
<!-- There should be a bunch of quotes for each cardinal virtue. All quotes are listed at the introduction of each section. Select one for an individual tutorial. -->
...
<!-- conditional_effects(), ranef() if relevant -->
...
<!-- Questions and Answers; Humility; Probably first need a question which builds the new tibble. -->
