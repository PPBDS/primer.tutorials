...
<!-- DK: Split above into two questioms. First, build the pipe. Second, tell them you have assigned the result of the pipe to an object, have them print that object. Name of object should be `x` or something similarly short and bland. All to be done in the EDA. -->


<!-- DK: A plot can be a knowledge drop. -->
...
<!-- I feel like we aren't giving the authors enough guidance about how to explain the math part of the model, both making the latex and also understanding it, especially why character/factor variables get changed. Some with the words part of the model. We need to help them translate code into words. We generally just tell them the code. -->
