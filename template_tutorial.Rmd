...
<!-- DK: Add the Temperance start and finish sentences from the Primer chapters? -->

<!-- DK: The Preceptor Table does not include all the covariates which you are eventually including in your model. It only includes covariates which you need to answer your question.  -->

<!-- DK: The word "columns" should always be included in our example of validity being violated. -->
