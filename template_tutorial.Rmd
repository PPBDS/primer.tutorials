...
<!-- DK: Not sure how much of this section can be standardized. We certainly always begin by defining Temperance and revisiting the question(s) we started with. There will certainly be questions which build newdata tibbles. And then questions which use them. Perhaps we will usually replicate a plot from the Primer. We always end with a paragraph summary. -->
