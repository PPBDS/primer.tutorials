...
<!-- XX: In this knowledge drop, remind them about the outcome variable and the key covariate. Discuss any other variables which you also will include in the formula, explaining that you want to "adjust" --- not "control" --- for them.  -->
