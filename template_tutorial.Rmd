...
<!-- * General introduction to the topic. Almost always along the lines of either a rhetorical question or a claim that Y is important or changing or interesting or . . . -->

<!-- * Using data from (mention date, collection method (?) and organization (if famous)), I/we seek to understand outcome variable, which (give some information about outcome variable.), in order to (estimate the causal effect | compare two groups) for when/where. -->

<!-- * Tell me a weakness involving the key assumptions. Be wary of using technical terms. -->

<!-- * I/we model Y (the concept of the outcome, not the variable name; we almost never use any variable names, just like we never mention specific R code) as a linear/logistic/ordinal function of X (and maybe other covariates.) -->

<!-- * Tell me a QoI and the uncertainty associated with it. -->
