...
<!-- GK: We already load this in the Question, is it redundant to load it again here? -->
...
<!-- XX: Load any other packages that are needed, one package per question. (But make sure that they are also included in the setup chunk.) primer.data, for example, is often needed. But save tidymodels, broom and marginaleffects for the Courage section. -->
