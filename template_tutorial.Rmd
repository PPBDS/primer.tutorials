...
<!-- Should their be two questions about stability just as with representativeness. Probably! -->

<!-- Representativeness problems are easy to state. The knowledge drop then explains how that problem, if true, might lead to biased parameter estimates. Do your best not to make time part of your representativeness counter-example.  -->
...
A change in time or the distribution of the data does not, in and of itself, demonstrate a violation of stability. Stability is about the parameters: $\beta_1$, $\beta_1$ and so on. Stability these parameters are the same in the data as they are in the population as they are in the Preceptor Table.
