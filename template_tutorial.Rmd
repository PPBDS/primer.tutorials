...
<!-- Should be a question asking for the four Cardinal Virtues for doing data science, but maybe, in later tutorials, as a jokey list, like without vowels or spelled backwards or whatever. Use AI to answer! -->
...
<!-- We should address non-numeric potential outcomes as a knowledge drop which always appears. -->

<!-- In the Temperance questions using marginaleffects should have a bunch of default knowledge drops about what the model means, what the `by` argument does, and so on. This would parallel the knowledge drops we provide for the coefficient interpretation questions.  -->
...
<!-- XX: The purpose of the "Imagine" paragraph is to describe a real person in the world with real decisions to make who has some data and some problems. In general, this person has lots of data and lots of problems and lots of decisions to make. And they are a real person! This motivates the work that we will do below. -->

<!-- XX: Example: Imagine that you are running for Governor of Texas in the next election. You have a campaign budget. Your goal is to win the election. Winning the election involves convincing people to vote for you *and* getting your supporters to vote. Should you send postcards to registered voters? What should those postcards say? Does the effect of the postcards vary for different types of voters?  -->
