...
# needed because we show a Preceptor Table to the students, which is built with
# this package, even though we don't show students how to create it.
...
# in the Console. (Of course, different lines of code requires different
...
<!-- Review all the other tutorials. -->

<!-- Add 10 questions to the Question section. Including determining if it is predictive or causal. Also quantity of interest.  -->

<!-- Ask to identofy an outcome. Ask to identify a key covariate.  -->

<!-- Then, come up with a causal question and a predictive question. Make the point that predictive questions always make sense. Causal questions are sometimes nonsense. -->

<!-- Tell them, here is our question. Then, what quantity of interest might you be interested in? Do this at least twice. -->

<!-- Start experimenting with tutorial 6 by adding a section. -->

<!-- Begin with 3 to 5 questions about the data. There might be some questions with only one correct answer in this part.  -->

<!-- Ask them a series of questions, to which there are no correct answers. It just forces students to think. It gives us an excuse to drop knowledge. -->

<!-- By the end of The Question section, we tell them: "This is the question we will answer. This is the Quanity of Interest we care about." -->

<!-- Add advice to writers of what to do with with the causal section on a predictive model. -->


<!-- It is unclear to me if loading libraries like tidyverse and primer.data should be part of The Question section. On one hand, it is natural to include them, especially since we need to look up the help page for the data. And the Wisdom section is already pretty long. On the other hand, it feels a bit like jumping the gun. -->
...
<!-- Begin with some information about the data set. Maybe require them to look up info about it. Maybe copy/paste help page or other sources. -->
...
<!-- DK: Add question: Explain why you want to use a predictive model or a causal model. Answer is almost always, you care about what happens to the same unit under two different treatments or you don't care. Often uses words like "causal," or "effect" or "affect" or "influence" or "impact" or . . . Actually, this should now be handled in The Question section. -->

<!-- XX: Next three questions are only included for a causal model. DK: No! Keep them! Come up with causal scenario even if it is a predictive model. -->
...
<!-- XX: Drop some knowledge making it clear how this definition applies in the current problem. -->
