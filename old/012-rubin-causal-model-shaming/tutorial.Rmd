...
<!-- DK: This is pretty good. Or, at least it has potential. -->
...
Using the data, we'll be making this [`gt` table](https://gt.rstudio.com/) to find how different treatments (the postcards) and covarients impact whether people vote (primary_06).
...
Write a paragraph that explains the shaming experiment in the context of the Rubin Causal Model. It should use these terms: “unit,” “treatment,” “outcome,” “potential outcomes,” “casual effect,” “assignment mechanism,” and “heterogeneous treatment effects.” Do not discuss “Preceptor Tables.”  
...
For our last tibble, We will investigate whether the ATE of Neighbors and No Postcard is influenced by the covariate `age`. Units will be seperated into groups `old` and `young`. 'Old' is defined as anyone older than 64, and 'young' is anyone 64 or lower.
...
By changing `Neighbors` to be the leftmost column, it formats the table to look cleaner, since the way you calculate ATE is Neighbors - No Postcard, rather than No Postcard - Neighbors. Details matter!
