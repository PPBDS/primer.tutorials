...
# the all.primer.tutorials which is loaded is the one which is there. But you have
...
# way," by building the tar ball. From that tarball, I know all.primer.tutorials is
...
package_location <- system.file("tutorials", package = "all.primer.tutorials")

tutorial_paths <- available_tutorials("all.primer.tutorials") |>
