...
Have them fork a buggy repo. 
 - I really want to show them branches because it's an integral part of Git and is brought up in almost every Git tutorial. The majority of Git and GitHub is in dealing with branches for different people and holding multiple branches. Not teaching branches is like not teaching them how to contribute to a running Git repo.
