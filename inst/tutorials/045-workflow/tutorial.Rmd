...
<!-- AG: Add .Rprofile thing here, not completely sure as to what I should do. -->
...
<!-- AG: Error is going to be in wrangle since that's where a lot of errors occur -->
...
<!-- AG: Styling the R Script files only. Not really sure what the RMarkdown guidelines are though so not including them. -->
...
<!-- AG: Not sure if you can show a gist in a pdf doc -->
