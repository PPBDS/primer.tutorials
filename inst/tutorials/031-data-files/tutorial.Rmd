...
We will use the Google sheets provided from the **googlesheets4** [documentation](https://googlesheets4.tidyverse.org/).  The url is "https://docs.google.com/spreadsheets/d/1U6Cf_qEOhiR9AZqTqS3mbMF3zt2db48ZP5v3rkrAEJY/edit#gid=780868077". Use `read_sheet()`, with the `url` argument, to read it in.
...
read_sheet(ss = "https://docs.google.com/spreadsheets/d/1U6Cf_qEOhiR9AZqTqS3mbMF3zt2db48ZP5v3rkrAEJY/edit#gid=780868077")
```
