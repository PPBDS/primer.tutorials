...
<!-- Own every word here. Do the entire tutorial again. Done.-->

<!-- Add copy buttons as appropriate. Done.-->

<!-- Exercise 2 should use `show_col_types = FALSE` to get rid of that ugly guessing. Done.-->

<!-- col_select also looks interesting. Also read_tsv("/tmp/flights_AA.tsv", name_repair = janitor::make_clean_names) -->


<!-- Be aware of new readr 2.0 version which may make some questions obsolete. Done, did not see any questions not working See: -->

<!-- https://www.tidyverse.org/blog/2021/07/readr-2-0-0/ -->

<!-- Add meat to JSON section. Done. -->
...
<!-- A question or two about name.repair with read_csv(). Example: name_repair = janitor::make_clean_names -->
