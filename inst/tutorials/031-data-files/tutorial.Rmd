...
```{r csv-files-12-hint, eval = FALSE}
...
```{r csv-files-13-hint, eval = FALSE}
...
```{r csv-files-14-hint, eval = FALSE}
...
```{r parsing-multiple-fil-1-hint, eval = FALSE}
list.files("data")
```
###
...
```{r parsing-multiple-fil-2-hint, eval = FALSE}
...
```{r parsing-multiple-fil-3-hint, eval = FALSE}
...
```{r parsing-multiple-fil-4-hint, eval = FALSE}
list.files("data", pattern = "similar", full.names = TRUE) %>% 
  read_csv()
```
###
...
```{r parsing-multiple-fil-5-hint, eval = FALSE}
... %>% 
  read_csv(na = ".")
```
###
...
```{r parsing-multiple-fil-6-hint, eval = FALSE}
...
```{r parsing-multiple-fil-7-hint, eval = FALSE}
... %>% read_csv(na = ".", show_col_types = FALSE, 
                 name_repair = janitor::make_clean_names)
```
###
