---
title: Three Parameters B
tutorial:
  id: three-parameters-b
output:
  learnr::tutorial:
    progressive: yes
    allow_skip: yes
runtime: shiny_prerendered
description: More examples of three parameter models.
---
...
<!-- Change text questions to allow for written answers, and then provide your own perfect written answers. -->
...
```{r eda-trains-2, exercise = TRUE}

```

```{r eda-trains-2-hint-1, eval = FALSE}
trains %>% 
  select(...)
```
...
```{r eda-trains-3, exercise = TRUE}

```

```{r eda-trains-3-hint-1, eval = FALSE}
trains %>% 
  select(liberal, att_end, income, treatment) %>% 
  ggplot(aes(x = ..., y = ...)) + 
...
```{r income-as-a-function-7, exercise = TRUE}

```

```{r income-as-a-function-7-hint-1, eval = FALSE}
...
```{r income-as-a-function-8, exercise = TRUE}

```

```{r income-as-a-function-8-hint-1, eval = FALSE}
fit_obj <- stan_glm(income ~ liberal - 1, 
                    data = trains, 
                    refresh = 0)
...
```{r income-as-a-function-11, exercise = TRUE}

```

```{r income-as-a-function-11-hint-1, eval = FALSE}
fit_obj %>% 
  as_tibble() %>% 
  select(-...) 
```
...
```{r income-as-a-function-12, exercise = TRUE}

```

```{r income-as-a-function-12-hint-1, eval = FALSE}
... %>% 
pivot_longer(cols = ... : ...,
             names_to = "...",
             values_to = "...")
...
```{r income-as-a-function-13, exercise = TRUE}

```

```{r income-as-a-function-13-hint-1, eval = FALSE}
fit_obj %>% 
  as_tibble() %>% 
  select(-sigma) %>% 
  pivot_longer(cols = liberalFALSE :liberalTRUE,
...
```{r income-as-a-function-14, exercise = TRUE}

```

```{r income-as-a-function-14-hint-1, eval = FALSE}
Remember you are adding a layer here! ( you must use "+")
```

```{r income-as-a-function-14-hint-2, eval = FALSE}
... + 
  scale_y_continuous(labels=scales::percent_format()) +
  scale_x_continuous(labels=scales::dollar_format())  
```
...
```{r income-as-a-function-15, exercise = TRUE}
...
```{r income-as-a-function-17, exercise = TRUE}

```

```{r income-as-a-function-17-hint-1, eval = FALSE}
...
```{r income-as-a-function-18, exercise = TRUE}

```

```{r income-as-a-function-18-hint-1, eval = FALSE}
pp  <- posterior_predict(fit_obj, 
                         newdata = ...)
...
```{r income-as-a-function-19, exercise = TRUE}

```

```{r income-as-a-function-19-hint-1, eval = FALSE}
tibble(income = pp[, 1])
```
...
```{r income-as-a-function-20, exercise = TRUE}

```

```{r income-as-a-function-20-hint-1, eval = FALSE}
tibble(income = pp[, 1]) %>% 
...
```{r income-as-a-function-21, exercise = TRUE}

```

```{r income-as-a-function-21-hint-1, eval = FALSE}
... %>% 
