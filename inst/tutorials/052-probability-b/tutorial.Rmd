...
<!-- Second example. Show what happens when the mathematical assumptions are false, with rolling two dice. Use the weight argument in sample so that 5s and 6s are more common in both dice. Weights should be slight, like 20% chance of 5 or 6, 15% chance of others. Maybe we do a similar plot, but with just three panes, 10, 50, 10,000.  -->
