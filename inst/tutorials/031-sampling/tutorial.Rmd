...
# DK: Your question is: Type `shovel` to see the tibble which we have 
# created which includes the data from the shovel.			

set.seed(9)
shovel <- tibble(color = as.factor(sample(c(rep("red", 17), rep("white", 33)))))
