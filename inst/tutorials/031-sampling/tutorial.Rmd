...
```{r virtual-sampling-9-test, include = FALSE}
set.seed(10)
...
```{r virtual-sampling-10-test, include = FALSE}
urn <- tibble(color = c(rep("red", 400), 
                        rep("white", 600))) |> 
  sample_frac()
```
...
```{r virtual-sampling-12-hint-2, eval = FALSE}
...
<!-- Should be separate into smaller questions -->
...
```{r virtual-sampling-13-hint-2, eval = FALSE}
... |> 
