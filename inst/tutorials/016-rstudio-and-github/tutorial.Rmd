...
**Warning**: The RStudio Cloud managed by Simmons does not currently allow access to the Terminal. Students who are using it are exempt from Terminal-related questions. *However*, they should be able to complete all Terminal-related tasks by using the menus on the File tab. Go there to create a new folder, copy files and so on.
