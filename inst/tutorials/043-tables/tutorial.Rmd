...
```{r}
# This palette was chosen since conservationism is associated with red, and
# liberalism with blue.

color1 <- paletteer_c("ggthemes::Red-Blue-White Diverging", 13)

# Function by Greg Lin. Higher bias gives more widely spaced colors at the high
# end. Needs to be positive. These biases where chosen to ensure that half the
# scale is red in color, and half is blue
...
my_color_function <- function(value){
...
reactable1_t <- trains %>%
  ...
  select(gender, age, race, party, att_start, att_end, att_change, 
         ideology_start, ideology_end, ideology_change) %>%
