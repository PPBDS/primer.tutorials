...
Create an new column called Y using mutate(), this time use map_dbl(), set the first argument to Y represent data source, the second argument to the `sample()` *Formula* we created in the last exercise.
...
```
<!-- TM: Says to set Y as data source in map_dbl in exercise but sets ID as data source in hint -->
### 
...
<!-- TM: Better knowledge drop about "runif()" ? -->
### Exercise 11
...
<!-- TM: Maybe add knowledge drop about set.seed here --> 
...
<!-- TM: Make adding "after_stat" instructions clearer across the board. -->
