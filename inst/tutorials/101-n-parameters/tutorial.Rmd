...
We will be looking at the shaming tibble from the [**primer.data**](https://ppbds.github.io/primer.data/) package, sourced from “[Social Pressure and Voter Turnout: Evidence from a Large-Scale Field Experiment](https://doi.org/10.1017/S000305540808009X)” by Gerber, Green, and Larimer (2008). Familiarize yourself with the data by loading **primer.data** at the Console and then typing `?shaming`.
