...
What are some more specific questions related to our general question which we can answer using the `shaming` data? 

```{r the-question-2}
question_text(NULL,
	message = "There are several question we could ask. For example, we could find the relationship between past civic engagement and likelihood of voting in the current election.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Which variable in `shaming` should we use as our outcome variable?
