...
Change the call to `fit()` to `fit(as.factor(primary_06) ~ sex + age + treatment*voter_class, data = x)`. This is just like our last model, but it adds interaction terms between `treatment` and `voter_class`.
