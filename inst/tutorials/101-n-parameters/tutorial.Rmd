...
```{r justice-16}
question_text(NULL,
	message = "One weakness of our model is that it may be biased if the people who received postcards differ in important ways from those who did not, such as being more likely to vote even without a postcard.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
We need `fit_vote` to exit in Console World. Copy/paste this code into the Console and execute it.
...
Justice:
> **One weakness of our model is that it may be biased if the people who received postcards differ in important ways from those who did not, such as being more likely to vote even without a postcard.**

```{r courage-16}
question_text(NULL,
	message = "I model voting behavior (whether a person votes or not) as a logistic function of their age, sex, treatment group, and voter engagement class, as well as interactions between treatment and voter class. The model predicts the probability of voting based on these covariates.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
