...
```{r age-party-graph-14, echo = FALSE}
age_party_graph
```
...
In two sentences, provide a reason why the *assumption of representativeness* might not hold.

```{r income--age-2}
question_text(NULL,
	message = "We could still not assume representativeness because those who actually complete and submit the survey are not random. We could possibly see a skewing in the age distribution and overestimate of the younger people in the population, and if younger people also tend to have a lower income than older people, this could also alter our answers to our current questions.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
