...
### Preliminaires Section

Each tutorial should have a preliminaries section which reminds students of any tricks which are needed later, even if we have already seen those functions in earlier chapters. This should be its own side panel. This section should be come right after the name and email sections.
...
Each answer should always spit out something. Interactivity is good! Students should always look
...
1. Make them build step by step, one line after the other. Setting up interim results is confusing. Set up chunks are a bad idea. Get rid of all of them! 
