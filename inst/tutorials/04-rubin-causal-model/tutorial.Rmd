...
As we do in the book, let's now assume that the causal effect varies by sex. We will use two estimates for tau. (Cassidy and Emma are female, Tahmid, Diego, and Yao are male).
