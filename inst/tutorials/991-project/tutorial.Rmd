...
<!-- 2) Replace all the example sentences to make them much better, presumably using material from tutorials 8, 9, 10, which might also be improved. -->

<!-- 3) Figure out where the link to the spreadsheet belongs. Probably best if it is just described as being distributed by the instructor. -->
...
Pin your model project repo to your profile page following the instructions listed [here](https://docs.github.com/en/account-and-profile/setting-up-and-managing-your-github-profile/customizing-your-profile/pinning-items-to-your-profile).
...
If your project is includes model, write your relevant sentence(s) below. Otherwise, skip this question.
...
* Delete the R project folder. At this point, the only existence of your project is the repo.

* Click on "Settings" and change name of repo on Github. 

* Re-clone it using the new url, connecting to a new R project on your computer.   
...
```
tutorial.helpers::show_file("README.md", pattern = "http")
```

CP/CR. This should, at least, pull up the link to your Quarto website. It is OK if it pulls up other websites mentioned in the README.


```{r github-repository-2-ex}
question_text(NULL,
	answer(NULL, correct = TRUE),
	allow_retry = TRUE,
	try_again_button = "Edit Answer",
...
You might think that there is no reason to a professional README for the repo. After all, the `about.qmd` page already explains the project. **You would be wrong.** Professionals care about documentation. A clean, complete README demonstrates your professionalism.
...
The Models page, created from `models.qmd`, provides details about the model which you used. This does not show any code. Indeed, nowhere does the project show code. If someone wants to look at your code, they can go to your Github repo. First, this page will include the mathematical formula of your final model. (See examples in the *Primer*.) Second, this page will include information about the model's parameters, generated from the fitted model. We recommend creating a table using [**gtsummary**](https://www.danieldsjoberg.com/gtsummary/) package. 
...
To "submit" your project, we'll be adding it as a row in [this spreadsheet](https://docs.google.com/spreadsheets/d/1iXU0tQhM4GY7_47n22FQMx1tzW09h6H9Uk4v0HPaGSw/edit?usp=sharing). This section will guide you through that process. The information you enter will be used to populate our [final project website](https://bootcamp.davidkane.info/projects.html).
