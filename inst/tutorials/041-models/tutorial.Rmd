...
```{r temperance-2}
question_text(NULL,
	message = "A log-odds intercept of -0.32 corresponds to a 42% probability of supporting Biden in the baseline case.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
The -0.32 intercept indicates 42% baseline support probability. The 95% CI (-0.42 to -0.22) suggests the true value likely falls between 40-45%. 
...
preds %>%
  ...
  labs(
    ...
    subtitle = "Estimated probability of saying 'Yes' to supporting Biden.",
    caption = "Source: Survey data modeled using logistic regression",
