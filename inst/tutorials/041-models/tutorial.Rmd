...
```{r wisdom-19}
question_text(NULL,
	message = "The Preceptor Table consists of rows representing individual voters in the 2024 U.S. presidential election, with columns showing whether or not the individual voted for Biden.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
