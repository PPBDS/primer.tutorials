...
<!-- DK: Make sure everything has a knowledge drop. You can use the defaults for the parameters.  -->
...
<!-- DK: Confirm that the Population Table looks good. -->
...
<!-- DK: Wrong. You only fit one model. -->
...
<!-- DK: Wrong. Get AI to help. Check the template tutorial. -->
