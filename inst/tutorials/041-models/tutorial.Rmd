...
```{r wisdom-1}
question_text(NULL,
    message = "Possible answers: 1) People might change their minds before voting, 2) Poll participants might not represent all voters, 3) People might not answer polls truthfully",
