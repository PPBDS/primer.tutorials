...
<!-- DK: This is not general enough. Hold off on specifics till later. -->
...
```{r wisdom-7}
question_text(NULL,
	message = "One key covariate to explore might be `age`, since voter preferences often vary by age group.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 2)
