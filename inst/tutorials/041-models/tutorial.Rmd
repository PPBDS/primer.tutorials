...
In the Console, run `check_predictions(fit_biden)`. There will probably be an error. CP/CR.
...
We are having trouble getting `check_predictions()` to work on this model. Sorry!
