...
In this new R Project, create a new Quarto Document. Set the title to `Models` and the author to you. Remove all the junk after the YAML header. Save the file as `models.qmd`. Note that the `.qmd` extension will be added automatically.
...
Add these sentences to `models.qmd`.
...
Edit `models.qmd` accordingly, but do not just copy/paste our answer.
