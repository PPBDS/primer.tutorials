...
<!-- TJ: Are we supposed to do anything to the quarto documennt? -->
...
<!-- TJ: This is better off as a separate question -->
...
<!-- TJ: The second sentence is not in the Primer -->
...
<!-- TJ: I feel it would be better to remove this question altogether and explain that unconfoundedness is not relevant since this is a predicative model in the knowledge drop above -->
