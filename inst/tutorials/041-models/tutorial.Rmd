...
<!--   fit(BidenVote ~ biden, data = poll_data) -->
...
<!-- <!-- AT: Discuss with preceptor about how to handle this as there is only one variable in the data --> -->
...
<!-- <!-- AT: Still need to fix the fit() functions --> -->

<!-- Change the call to `fit()` to `fit(XX, data = poll_data)`. -->
