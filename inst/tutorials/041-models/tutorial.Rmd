...
<!-- Since the Console is currently busy running this tutorial, you should use `File -> New Window` to create a new Positron window in which you will  -->
...
The polling data comes from a YouGov survey of 1,559 U.S. adult citizens conducted March 10-12, 2024. The tibble `poll_data`, which has been loaded up in the workspace of this tutorial, contains that data.
...
Connect the Github repo to a project on your computer. 
