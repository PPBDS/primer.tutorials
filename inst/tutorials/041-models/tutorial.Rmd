...
Before looking at any data, write down 3 potential challenges in predicting election outcomes from polls.

```{r wisdom-1}
question_text(NULL,
    message ="1) People might change their minds before voting, 2) Poll participants might not represent all voters, 3) People might not answer polls truthfully",
