...
loans <- read_csv("https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/refs/heads/master/csv/openintro/loans_full_schema.csv")

fit_loans_model <- rand_forest(mode = "regression", engine = "ranger", mtry = 8, trees = 5, min_n = 17) 
  ...
  plot_predictions(fit_loans, condition = "debt_to_income")
```
