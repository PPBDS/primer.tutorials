...
*What is the probability that if a Democrat shows up to a train station, he will be over 50 years old?*

*In a group of train commuters in which three are Democrats and three are Republicans, what will the age difference be between the oldest Democrat and the youngest Republican?* 


```{r wisdom-1}
question_text(NULL,
	message = "We would have columns for political affiliation and age of train commuters.",
	answer(NULL,
	correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
...
*What is the largest causal effect on immigration attitudes due to exposing commuters to Spanish-speakers which still has a 1 in 10 chance of occurring?*
...
*What would you expect the income to be for a random 40 year old train commuter?*
...
In order to do so, first make a new tibble with one observation of the `party set to the value of the "Democrat". Set this equal to `new_obs`.
