...
Assign the provided html code into the variable `raw_html_1`.
...
Copy/paste your pipe from above and extend it with ` %>% `. Select the main content element with the function `html_element()` using its `#mw-content-text` attribute.
