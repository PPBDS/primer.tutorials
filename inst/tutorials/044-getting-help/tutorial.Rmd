...
<!-- Read https://ppbds.github.io/primer/tools.html#how-to-get-help SG: Done -->

<!-- Include all the above (useful) material in this tutorial. SG: Done -->

<!-- Read this. This is nice: https://themockup.blog/posts/2021-07-28-reminder-to-test-with-a-reprex/  SG:Done -->

<!-- Add to reprex: https://www.garrickadenbuie.com/blog/shrtcts-reprex-to-issue/ SG: Done-->

<!-- Add a link: https://www.youtube.com/watch?v=5gqksthQ0cM SG: Done -->

<!-- Read this. Useful? Link? https://www.r-project.org/help.html 
SG: I think it is unnecassary because there is already something that addresses this in the tutorial, I added a little more to make it more detailed -->
...
<!-- DK: This thread will close in November. They close automatically. What should we do about that? Maybe I can just add a reply each month and then the two month clock starts again? -->

<!-- DK: Perhaps useful: https://www.garrickadenbuie.com/blog/shrtcts-reprex-to-issue/ -->

Visit [this RStudio Community thread](https://community.rstudio.com/t/thread-for-students-in-kanes-data-science-bootcamp-to-post-example-questions/140111) and reply to the thread by clicking the "Reply" button. You will have to create an RStudio Community account.
...
In the future when you post to RStudio Community, be sure to keep the window open for a few seconds after you have pasted your question into the window. (Doing to will prevent your post from being sent to Moderation out of concern that you are a bot.)
...
To learn more about reprex, its features, and some shortcuts, visit the following website: https://www.garrickadenbuie.com/blog/shrtcts-reprex-to-issue/

Another useful video that includes real-world scenarios and more specific usage of reprex is https://www.youtube.com/watch?v=5gqksthQ0cM

We strongly encourage you check at least one of these out to get a more developed understanding of reprex!
