...
Let's make a list of R authors whose first or last names contain the letter `d`. Run `grep "d"
...
`grep` is used to search for a string of characters within a text file. 

### Exercise 13

Use `grep` to make a list of authors whose first or last names begin with the letter `D`. Run `grep "D"
