...
<!-- Use . and .. at least three times. Especially cd .. and mv something . Note that you can only use this trick if two conditions hold: you are in the location to which you want to move the file and you don't want to change its name. Otherwise you need the full move: mv something to-something-else. [done for ..] -->
