...
Let's make our fake more convincing. The new names are not in the same place as the other names. One tool to edit text files in Terminal is `nano`. Run `nano AUTHORS-fake.txt`. 
