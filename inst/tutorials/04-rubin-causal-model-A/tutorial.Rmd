...
file <- system.file("images/preceptor_table_def.PNG", 
...
file <- system.file("images/casual_effect_def.PNG", 
                           package = "primer.tutorials")
img <- readPNG(file)
grid.raster(img, just = "centre")
```
...
file <- system.file("images/fpoci_def.PNG", 
                           package = "primer.tutorials")
img <- readPNG(file)
grid.raster(img, just = "centre")
```
...
file <- system.file("images/ideal_preceptor_def.PNG", 
                           package = "primer.tutorials")
img <- readPNG(file)
grid.raster(img, just = "centre")
```
...
file <- system.file("images/actual_vs_ideal.PNG", 
                           package = "primer.tutorials")
img <- readPNG(file)
grid.raster(img, just = "centre")
```
...
```{r yao-image-answer}
file <- system.file("images/yao_calc.PNG", 
                           package = "primer.tutorials")
img <- readPNG(file)
grid.raster(img, just = "centre")
```
...
file <- system.file("images/tahmid_calc.PNG", 
                           package = "primer.tutorials")
img <- readPNG(file)
grid.raster(img, just = "centre")
```
...
```{r tao-image-answer}
file <- system.file("images/tao_calc.PNG", 
                           package = "primer.tutorials")
img <- readPNG(file)
grid.raster(img, just = "centre")
```
