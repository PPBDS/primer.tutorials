...
In this tutorial, we will combine practice with data wrangling with more advanced plotting. Most of professional data science is not building fancy models. Instead, the focus is on organizing/arranging our data so that we can work with it more easily. 
...
In this tutorial, you have practiced your wrangling skills. For the most part, we wrangle to make our plots better. [ggplot2: Elegant Graphics for Data Analysis](https://ggplot2-book.org/) is wonderful (and free) resource for improving your graphics skills.
