...
The `baby_data` data set consists of all the names, what year, what gender, the number of people that have the same name, and the proportions of people that have the name compared to everybody born in that year. We will be using this data to analyze the popularity of top 10 names each year.
...
```{r babynames-15-hint-1, eval = FALSE}
why <- ... %>%
