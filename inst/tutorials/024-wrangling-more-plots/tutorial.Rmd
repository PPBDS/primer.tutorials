...
<!-- BL: facet wrap does not work here. -->
...
Copy and paste the code above. Adjust the feel of your graph by adding the layer `theme_classic() `. Now add the `labs()` layer. As you set the labels, pay particular attention to how the y-axis label and subtitle should change compared to the previous plot. 
