...
<!-- Assume that they have done the first two visualization tutorials.  -->
<!-- Get rid of all Git/Github. -->
<!-- Use the R script to create a png or jpeg with ggsave(). Then use list.files() to prove that you created it. -->
<!-- IN the R markdown, also use include_graphics to read in the image you created with ggsave(). -->
<!-- Delete images that are not used here. -->
...
Whenever you start a new project, you will want to store it somewhere on your computer to find it easily. For this purpose, you should create a `projects` folder. We'll be using this folder to keep our R projects organized and separated from the rest of your files.

Remember that you shouldn't use spaces in file or folder names, so you might want to use a dash or period to seperate words instead.

### Exercise 1

### 

After your folder is made, you should move your current workspace into your r projects folder. 
