...
We will use the `ch_7_female` tibble in the questions which follow.
...
Great! We should save our model to be able to work with it in future questions, so we need to assign it to an object. In this case, we call it `fit_obj`. Run this code.
...
`fit_obj` is available for use in later questions.
