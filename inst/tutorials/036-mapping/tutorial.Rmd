...
Run `git reset --hard HEAD~1` in the Terminal. This will reset you to the commit before the HEAD commit (or the one that you are currently on). Keep in mind that this will reset all of your 
