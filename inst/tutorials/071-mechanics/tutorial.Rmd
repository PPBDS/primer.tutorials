...
Using the raw data, the distribution is heavily skewed to the left. However, we do not know the “true” model, who is to say that a model using the raw value is right or wrong?
