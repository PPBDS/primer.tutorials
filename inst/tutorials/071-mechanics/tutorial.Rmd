...
# Delete once you have replaced the brm objects.
...
Pipe `linear_reg()` to `pipe()`, with arguments `income ~ age` and `data = trains`.
...
Behind the scenes, we have assigned the result of the pipe to an object named `fit_1`. Type `fit_1` and hit "Run Code." This will return a table of regression. 
