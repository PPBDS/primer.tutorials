...
Consider the first model which seeks to explain the attitudes towards immigration among Boston commuters, using political ideology (`liberal`) as the explanatory variable. Run the `brm()` command. Use the arguments `formula = att_end ~  liberal`, `data = trains`, `family = gaussian()`, `silent = 2`, `refresh = 0`, `seed = 12`. Assign the result to an object called `fit_liberal`. 
...
<!-- DK: Replace `fixef()` and similar functions with tidy() equivalents. -->
