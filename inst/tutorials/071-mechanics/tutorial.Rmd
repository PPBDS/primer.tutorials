...
<!-- DK: Add test code chunks for anything not too slow. Done -->

<!-- DK: Change the sections (topics). One should be "Log Transformations". Do this first, Next is "Scaling". Done, Check to see what else could be added?  -->
...
<!-- DK: Fix, here and elsewhere. Intructions, not questions. Done, I think -->
...
<!-- DK: Stop telling students to assign the result of a pipe to X. Done -->
...
<!-- DK: Replace `fixef()` and similar functions with tidy() equivalents. Done-->
