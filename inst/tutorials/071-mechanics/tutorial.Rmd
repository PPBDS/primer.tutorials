...
```{r transforming-variables-1-ex, exercise = TRUE}

```

```{r transforming-variables-1-hint, eval = FALSE}
library(brms)
```
...
```{r transforming-variables-2-ex, exercise = TRUE}

```

```{r transforming-variables-2-hint, eval = FALSE}
library(tidyverse)
```
...
```{r transforming-variables-3-ex, exercise = TRUE}

```

```{r transforming-variables-3-hint, eval = FALSE}
library(primer.data)
```
...
```{r transforming-variables-4-ex, exercise = TRUE}

```

```{r transforming-variables-4-hint, eval = FALSE}
library(broom.mixed)
```
...
```{r transforming-variables-5-ex, exercise = TRUE}

```

```{r transforming-variables-5-hint, eval = FALSE}
trains
```
...
```{r transforming-variables-6-ex, exercise = TRUE}

```

```{r transforming-variables-6-hint, eval = FALSE}
fit_1
```
...
```{r transforming-variables-7-ex, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r transforming-variables-7-hint, eval = FALSE}
fixef(...)
```
...
```{r transforming-variables-8-ex, exercise = TRUE}

```

```{r transforming-variables-8-hint, eval = FALSE}
... <- trains |> 
  mutate(... = age - ...(age))
```
...
```{r transforming-variables-9-ex, exercise = TRUE}

```

```{r transforming-variables-9-hint, eval = FALSE}
fit_1_c <- brm(formula = ..., 
               ... =  = trains_2,
               family = gaussian(),
               silent = 2,
...
```{r transforming-variables-10-ex, exercise = TRUE}

```

```{r transforming-variables-10-hint, eval = FALSE}
fixef(fit_1_c)
```
