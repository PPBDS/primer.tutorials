...
Navigate to the file tab in your RStudio session
...
Now, you should have a directory and repository called `first-website`.
...
In the console, load the package `usethis`. Type `use_git(message = "Initial commit")` into the console after.
...
Now, we are going to set up Github pages. Github pages is where we are hosting our website.

###

In the terminal, type `quarto publish gh-pages`. This will give you options Y/n. Type "Yes".

###

It should create a **Branch** called `gh-pages`. Publishing to Github pages can take a few minutes (it will tell you this in the terminal). After it is done building, it should pop up in the browser. Copy and paste the url of your website below.
...
A **Branch** is an independent line of development of the same project. You can think of them as a way to request a brand new working directory and project  history. You will need to switch to the master branch (or main branch) whenever you edit. Making a `gh-pages` branch allows github to convert everything over to html, so you will need to switch to the master/main branch.
