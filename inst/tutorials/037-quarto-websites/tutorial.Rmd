...
Copy and paste the following code into `references.bib`:
...
### Exercise 2 
The `@article` part at the very beginning can be changed to `@book`, `@webpage` and others, each of them having different required fields. 
