...
Go to File -> New File -> Quarto Document. Name it "Sources" (No quotes). Then select "Create Empty Document" (in the bottom left corner). This will create something that looks like this:
