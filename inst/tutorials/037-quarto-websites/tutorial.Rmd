...
It should create a **Branch** called `gh-pages`. Publishing to Github pages can take a few minutes (it will tell you this in the terminal). After it is done building, it should pop up in the browser.

###

A **Branch** is an independent line of development of the same project. You can think of them as a way to request a brand new working directory and project  history. You will need to switch to the master branch (or main branch)
