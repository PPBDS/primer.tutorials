...
Add a comment about the image in the code chunk with `#` .  
...
You can learn how to cite things [here](https://quarto.org/docs/authoring/footnotes-and-citations.html) but we will go over the basic things here.
