...
You should save them both (so they're not `untitled1` and `untitled2`). Change the titles to `"Source 1"` and `"Source 2"` in their respective places.
...
### 
After the colon add `sources`. Have it the exact same way as the `sidebar:sources`.
