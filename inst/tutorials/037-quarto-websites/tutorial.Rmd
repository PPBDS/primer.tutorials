...
In the console, run `list.files(all.files = TRUE)` to view a list of all the files in the directory. You should also see two hidden files, `.gitignore` and `.git`, along with some other files/directories.
