...
```{r creating-a-website-4-4, out.width = 350}
...
If you do not, close and then re-open R Studio (this will close the tutorial, just reopen it). If you still don't see one, go to `Build -> Configure Build Tools` and choose website for your build tools.

```{r creating-a-website-7, out.width = 400}
include_graphics("images/Build_tools.png")
```

```{r creating-a-website-7-2, out.width = 400}
include_graphics("images/Build_tools2.png")
```

You should now see a Build tab.
