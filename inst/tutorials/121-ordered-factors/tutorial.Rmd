...
These must be the right hand side variables in `fit_colleges`. 
...
```{r temperance-4}
question_text(NULL,
	message = "`tuition` will have the values 2.63075 and 3.73425, which represent the 75th and 25th percentiles. 'selectivity' will have the values 'Elite', 'Moderately Selective', 'Highly Selective', 'Lowly Selective' and 'Non-selective'",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
