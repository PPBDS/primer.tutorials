...
<!-- DK: The first time we show them selectivity.L and friends, we need to start to explain what it means. We often will drop the standard knowledge drop to make room. We explain it a couple of times, each time they appear again. But main message is: THIS TOPIC IS TOO ADVANCED FOR US TO FULLY EXPLAIN.  -->
...
<!-- DK: Please figure out and tell me! -->
