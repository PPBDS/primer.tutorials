...
```{r the-question-11}
question_text(NULL,
	message = "How does graduation rate differ in the top 75th percentile of tuition and the bottom 25th percentile of the most expensive 57% of colleges?",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
<!-- TJ: Is my wording ok for the answer? -->
...
Is `grad_rate` referring to graduation rates for 2-year degrees? 4-year degrees? 6-year degrees? Who knows?! If we want to know what graduation rate is for 4-year degrees and the data gives us information from 6-year degrees, we can't stack the columns on top of each other.
