...
<!-- DK: Add link to IPEDS -->

`college` contains data from over 900 colleges and universities in the United States. These draw primarily on data from the Department of Education’s (DOE) IPEDS database in 2013 and the College Scorecard. 
