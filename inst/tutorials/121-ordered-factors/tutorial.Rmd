...
```{r the-question-11}
question_text(NULL,
	message = "How does graduation rate differ for schools in the top 75th percentile of tuition and the bottom 25th percentile?",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Since our question is predicative, we could have only one covariate theoretically.
...
<!-- TJ: Could I just take this question out? I am already at 30 exercises in the Wisdom section Yes. -->
...
Take University of Michigan, UCLA and UC Berkeley for example. These are the three highest ranked public universities in all of America. Since they are publics, they charge a relatively low tuition rate compared to that of private institutes. But, they all have high graduation rates because they are prestigious. Because of this, we have to exclude such schools.
...
```{r wisdom-28}
question_text(NULL,
	message = "The column `grad_rate` from the data could be referring to any type of degree.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Is `grad_rate` referring to graduation rates for 2-year degrees? 4-year degrees? 6-year degrees? Who knows?! If we want to know what graduation rate is for 4-year degrees and the data gives us information from 2-year degrees, we can't stack the columns on top of each other.

<!-- TJ: Is this acceptable? No, as discussed. -->
...
```{r wisdom-29}
question_text(NULL,
	message = "The `tuition` column could be referring to standard tuition or tuition + fees",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
```{r justice-6}
question_text(NULL,
	message = "The colleges in the dataset may be from bigger, more expensive schools",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
If we Google "How many postsecondary institutes are in the United States?" We get a wide range on numbers, all significantly bigger than the 950 we have in the `colleges` dataset. These colleges excluded from this data were most likely smaller schools, with lower tuition rates and probably lower graduation rates.

<!-- TJ: Is this ok? Fix re discussion.-->
