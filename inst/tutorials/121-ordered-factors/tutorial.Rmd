...
```{r the-question-7}
question_text(NULL,
	message = "The graduation rate could increase when food is improved because it improves overall student life which is a factor when dropping out.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
<!-- TJ: I don't get the purpose of this question -->
...
```{r the-question-10}
question_text(NULL,
	message = "Some colleges might have a tuition of $90,000 per year. Others might have a tuition of $30,000. Those two groups will, on average, have graduation rate.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
<!-- TJ: Did I do this part correctly? -->
