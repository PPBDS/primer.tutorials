...
<!-- start with c(3,7,2,8,4)- replace rnorm with vector  -->
<!-- assign rnorm to x -->
<!-- notdoing a pipe here, enter a new line of code  -->
<!-- assigning it to variable in tibble tibble(x = rnorm) -->
<!-- assign it to tbl for them then have them  -->
<!-- take therange of tbl$x -->
<!-- create pipe summarize(range_x = list(range(x)) -->
<!-- tbl$range_x -->
<!-- then grab out first value using [[1]] -->
<!-- pipe tbl to str -->
<!-- tbl$range_x pipe str -->

### Exercise 1

Let's create a list column. First, let's begin by using `rnorm()` with the argument `12`. 
...
Assign your work to an object named `x`. One the line below, take the `range()` of `x`.
