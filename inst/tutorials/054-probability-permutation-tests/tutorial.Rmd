...
Exercise 1: Write one sentence describing the what the Preceptor Table would look like if the null hypothesis is true. Answer: The two potential ouctomes for each person would be the same and the column of causal effect estimates would all be zero. Drop the knowledge of the Preceptor Table.
...
Let's build a plot that calculate the estimated treatment effects for all assignments.
