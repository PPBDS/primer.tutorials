...
<!-- DK: Provide more specific examples of code you want them to run. Maybe? LIke create_website() with all the details filled in that they can copy/paste. Or is that bad? -->

<!-- DK: Need more advice/discussion/warnings about what happens if the Build tab does not appear. This happened to several students. -->
