...
In your browser, log in to your Github account. Navigate to your Repositories section. Create a new repository named `distill-tutorial` by pressing the green button in the top right of the screen. Give the repo a name and description of your choice and select the option to add a README file. 
...
To set up and manage the files needed to create a website with R Markdown files, we use the package `distill`. In the console of the other window, run `install.packages("distill")`. Then use the `library()` function to load the package. 
