...
<!-- Take ownership of the distill tutorial. Teach about weird vector error. -->
...
<!-- DK: Need more advice/discussion/warnings about what happens if the Build tab does not appear. This happened to several students. Tell them to close RStudio. Then use upper right project list to open --- by clicking the image on the right --- the test distill which they were working on. [done.] -->

<!-- DK: .gitignore should disappear  Should be test_distill.Rproj (or whatever the name is) should disappear. [done.] -->

<!-- DK: Need images to walk students through the Github pages stuff. [done.] -->

<!-- DK: Is the sdiff stuff really necessary? Don't keep around questions just because you wrote them. [done.] -->

<!-- DK: Need to cover the problems we saw in class. Get them to create the error by hand. Then have them fix it by hand. The cause is unclear to me. It is either having a random Rmd file in the project or it is messing up the yml file, which is easy to do. Or it is the failure to use create_article(). [done.]-->
