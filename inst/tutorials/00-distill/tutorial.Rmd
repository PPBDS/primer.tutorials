...
<!-- DK: Instead of "other R Studio instance," we should use a phrase like "other RStudio instance" or whatever. [done.] --> 
...
<!-- DK: .gitignore should disappear  Should be test_distill.Rproj (or whatever the name is) should disappear. [done.] -->
...
<!-- DK: Need to cover the problems we saw in class. Get them to create the error by hand. Then have them fix it by hand. The cause is unclear to me. It is either having a random Rmd file in the project or it is messing up the yml file, which is easy to do. Or it is the failure to use create_article(). [discuss]-->
