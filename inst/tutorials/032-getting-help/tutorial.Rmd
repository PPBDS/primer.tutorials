...
<!-- Note how this does not follow our Instructions, .e.g., no Introduction or Summary. -->
<!-- Does it really follow best practices. For example, you almost never see someone showing their data in a reprex. Instead, you build a reprex with built in data. If we want to show how to show data, that should be a separate question. -->

<!-- Remove part about running head(). -->

<!-- Watch Jenny Bryan. https://reprex.tidyverse.org/articles/learn-reprex.html -->
...
See [here](https://www.garrickadenbuie.com/blog/shrtcts-reprex-to-issue/) to learn more about reprex, its features, and some shortcuts. This [video](https://www.youtube.com/watch?v=5gqksthQ0cM) is also good. 
