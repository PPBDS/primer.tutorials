...
In the future when you post to RStudio Community, be sure to keep the window open for a few seconds after you have pasted your question into the window. (Doing so will prevent your post from being sent to Moderation out of concern that you are a bot.)
