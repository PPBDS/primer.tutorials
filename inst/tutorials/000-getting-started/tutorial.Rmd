...
<!-- Split into two. First would be just 4 + 5. -->

### Exercise 1

Let's practice some simple math. Below, we have already assigned 5 to `x` and 4 to `y`. On the line below those two given lines of code, add the two variables by typing `x + y`. Hit **"Run Code"** to see your results. Clicking **"Hint"** gives you a hint about what to type. 
