...
Change `x <- 5` to `x <- 10`. Hit "Run Code". You should get the answer 14.

###

Note that the assignment symbol --- `<-` --- is a less-than-sign followed by a dash. We often pronounce the symbol as "gets." So, we might say, when reading this code, "x gets 10."
