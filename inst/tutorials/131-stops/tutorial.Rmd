...
<!-- DK: Change discussion to potential outcomes, away from percentages and probabilities. -->
...
Imagine you’re a member of your city’s police department, and you believe strongly in fair and equal treatment for everyone. You want to ensure that a person’s race or age doesn’t unfairly affect their chances of being arrested during a traffic stop. But how can you know if bias exists? To find out, you start looking at the data—thousands of records of past stops—to see whether arrest rates are consistent across different groups. Your goal is to build a statistical model that helps uncover the truth: Are certain drivers more likely to be arrested just because of who they are? If so, you want to help make change.
