...
<!--     sex + race*zone -->
<!--     draw = FALSE -->
<!--     plot just black versus white estimates by hand, with zone ordered by something interesting. - DONE -->
...
<!-- SD: Is this a good QoI or did I do it wrong? -->

```{r the-question-12}
question_text(NULL,
	message = "We expect that the likelihood of getting arrested would be under 20% for White drivers, and this number would increase for Black drivers, accounting for other variables.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
<!-- FIX - Create Preceptor Table from template below -->
...
Provide one reason why the assumption of validity might not hold for the covariate `race`.

```{r wisdom-25}
question_text(NULL,
	message = "FIX - XX: Don't forget the word 'column'.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
<!-- DK: You can use exactly the knowledge drops from the template, but with the variable names/appearence edited to match your model. - DONE -->
...
<!-- FIX - Knowledge drop about error term going away and height with a hat -->
...
<!-- FIX - Explain in words what the code means. -->
