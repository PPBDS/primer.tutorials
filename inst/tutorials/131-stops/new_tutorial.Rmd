...
library(primer.data)
library(tidytext) #AP: was in the original tutorial, not sure when/where it is used
...
And explain what they mean! AP: working on it-->
...
<!--AP: this takes a little while to run. took about 15 seconds, do i need a note somewhere?-->
This is our table:
```{r}
...
<!--AP: this takes about 15 seconds to run, do I add a note or delete it? -->
###
