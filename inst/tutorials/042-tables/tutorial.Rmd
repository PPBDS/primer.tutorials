...
nominate %>% 
  ...
  kable(
    col.names = c("Party", "Name", "Year of Birth", "Year of Death", "State", "Ideological Position on Economic Matters", "Ideological Position on Societal Matters"),
    align = "l", 
...
`nominate` is a data set that provides information on congressional roll call votes in the United States from the first U.S. congress in 1789 to the 116th congress.
...
... %>% 
  kable(col.names = c("Party", "Name", "Year of Birth", "Year of Death", "State", "Ideological Position on Economic Matters", "Ideological Position on Societal Matters"))
```
...
<!-- AJ: KableExtra seems like a good package to cover, it adds a lot more customization options. -->
...
<!-- AJ: Should I add a section about creating a theme? There are no themes built-in to gt. -->
