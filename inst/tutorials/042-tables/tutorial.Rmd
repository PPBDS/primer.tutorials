...
### 
The **gt** we will learn about is even better than those other ones

Using **gt** you will be able to create better tables. If you want to learn more about this package, check out https://gt.rstudio.com.
...
Thomas Mock's blog is another resource that can be used to explore this package. 
...
Now run `?gt` on the next line to get more information about the `gt( )` function. This will give you an idea of what you need to make best use of this function.
...
Learn what the data means by running `?trains`.
