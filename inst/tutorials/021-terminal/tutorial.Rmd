...
WARNING: Some RStudio Cloud services do not provide a Terminal tab. If this is the case for you, do two things. First, you can accomplish many of the same commands by working in the File pane. There are buttons available there for creating a new director/folder, renaming files and so on. Second, just skip questions which you can not do because you do not have a Terminal tab.
...
**Be careful** with the rm command in Terminal. Unlike moving files to Trash, it is **irreversible**. If you delete certain things, it could cause damage to programs or your computer. 
