...
Run `cd` alone. Now, use `pwd` to check where you are. This is called the **home directory**, within which all an user's files are contained. Run `ls` to see what is inside your home directory.
