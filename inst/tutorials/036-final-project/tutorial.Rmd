...
Run `head index.Rmd` in the Terminal. CP/CR.
...
This should only return one line. If it returns multiple you still haven't followed the instructions above. You should make another page for any extra plots by creating another R Markdown file and adding it to the `_site.yml` file like in the Quarto tutorial.
