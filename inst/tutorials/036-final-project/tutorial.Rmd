...
<!-- Explain about pages which tell stories. Not too much in the index.Rmd page. The home page should not include more than 30 seconds worth of material. Pretty much just the four paragraph summary and then one key plot, which should look cool.  -->
...
<!-- Two examples for each sentence. Consistent across the sentences, so you will have two paragraphs at the end which you like. Ideally, use actual projects. Maybe your and Varun's projects! Maybe the knowledge drops after the submission in each are bad examples!? -->
