...
Let's implement the model using `stan_glm()`. The `formula` argument should be `lived_after ~ state + sex*election_age`. Set `data` to`ch_11`, and `refresh` to 0. Save your results to an object named `sham_2`.
...
<!-- BG: insert question from Wisdom section -->
