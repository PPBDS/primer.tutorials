...
Now let's graph our distribution. Start a new pipe with `ppd_reds_in_20`, and use `ggplot()` to map `new_reds` to the x axis, and fill to `above_eight`. Finally, add the layer `geom_histogram()`. 
