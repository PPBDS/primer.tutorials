...
Define `Wisdom` and its significance in data science in 2-3 sentences.

```{r cardinal-virtues-1}
question_text(NULL,
	message = " `Wisdom` refers to the ability to make decisions throughout the process of data science. It involves understanding the limitations and assumptions of the data at hand, knowing when to pursue further analysis or when to walk away, and making appropriate choices based on the available information."
,
...
By embracing `wisdom` in data science, data scientists can navigate the complexities and challenges inherent in working with data, leading to more reliable and insightful analyses, informed decision-making, and responsible use of data for the benefit of individuals and society as a whole.

### Exercise 2

Define `Justice` and its significance in data science in 2-3 sentences.

```{r cardinal-virtues-2}
question_text(NULL,
	message = "`Justice` refers to the step in data science that involves making assumptions about the structure of the data generating mechanism (DGM) and the mathematical formula linking the outcome variable to the covariates. By carefully considering the assumptions and structures of the DGM, data scientists can mitigate biases, make accurate predictions, and draw meaningful conclusions. ",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
`Justice` helps maintain ethical and responsible practices in data science by promoting fairness and transparency in the modeling process.

### Exercise 3

Define `Courage` and its significance in data science in 2-3 sentences.

```{r cardinal-virtues-3}
question_text(NULL,
	message = "`Courage` refers to the translation of mathematical formulas into practical implementations, allowing for the estimation of parameters, model fitting, and the exploration and analysis of data.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
###
`Courage` requires data scientists to acknowledge limitations, consider potential biases or unintended consequences, and make responsible choices during their variable/model selections.

### Exercise 4

Define `Temperance` and its significance in data science in 2-3 sentences.

```{r cardinal-virtues-4}
question_text(NULL,
	message = "`Temperance` refers to the virtue of exercising caution, humility, and self-restraint in data science. It involves acknowledging the presence of uncertainties in models, critically evaluating the realism and accuracy of assumptions, and being mindful of the limitations of estimated posterior distributions.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
By practicing `temperance`, data scientists can foster a more responsible approach to data analysis and formulating a more robust conclusions.
