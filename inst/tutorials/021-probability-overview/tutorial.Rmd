...
Causal models aim to determine the effect of manipulating a specific variable on the outcome by comparing two or more potential outcomes for each unit. The difference between predictive models and causal models is that the former have one column for the outcome variable in the Preceptor Table and the latter have more than one column.
