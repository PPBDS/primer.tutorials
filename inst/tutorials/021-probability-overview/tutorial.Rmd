...
- Are the data we have close enough to the data we want (i.e., the Preceptor Table) that we can consider both as coming from the same population?

- Do the columns in the Preceptor Table match the columns in the data?

- Are we are modeling (just) for prediction or are we (also) modeling for causation?
...
- Does the relationship among the variables demonstrate stability, meaning is the model stable across different time periods?

- Are the rows associated with the data representative of all the units which we might have had data for from that time period?

- Which general mathematical formula connects the outcome variable we are interested in with the other data that we have? (Causal Models)
...
- Which variables to include and to estimate the values of unknown parameters?
...
- How to use the model and DGM to answer questions?
