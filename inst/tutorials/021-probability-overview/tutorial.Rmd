...
## Probability Distributions With Flipping a Coin 
### 
...
```{r probability-distributions-with-ex-1, exercise = TRUE}

```

```{r probability-distributions-with-1-hint-1, eval = FALSE}
sample(..., ... , replace = ...)
```

```{r probability-distributions-with-1-hint-2, eval = FALSE}
...
```{r probability-distributions-with-ex-2, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r probability-distributions-with-2-hint-1, eval = FALSE}
tibble(... = sample(..., ..., ...))
```
...
```{r probability-distributions-with-ex-3, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r probability-distributions-with-3-hint-1, eval = FALSE}
... |> 
  ggplot(mapping = aes(...) + 
  geom_histogram()
```
...
```{r probability-distributions-with-ex-4, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r probability-distributions-with-4-hint-1, eval = FALSE}
... +
...
```{r probability-distributions-with-ex-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r probability-distributions-with-5-hint-1, eval = FALSE}
geom_histogram(aes(y = after_stat(count/sum(count))),
                 binwidth = 0.5,
                 color = "white")
```
...
```{r probability-distributions-with-ex-6, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r probability-distributions-with-6-hint-1, eval = FALSE}
Use the c() function for specifying the breaks and labels.
```

```{r probability-distributions-with-6-hint-2, eval = FALSE}
... + 
...
```{r probability-distributions-with-ex-7, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r probability-distributions-with-7-hint-1, eval = FALSE}
... + 
...
```{r probability-distributions-with-ex-8, exercise = TRUE}
...
## Probability Distributions With Rolling Two Dice
### 
...
```{r probability-distributions-with-2-hint-2, eval = FALSE}
...|>
...
```{r probability-distributions-with-3-hint-2, eval = FALSE}
...|>
mutate(die_1 = map_dbl(ID, ~ sample(c(1:6), size = 1))) |> 
```
...
```{r probability-distributions-with-4-hint-2, eval = FALSE}
...|>
mutate(die_2 = map_dbl(ID, ~ sample(c(1:6), size = 1))) |> 
```
...
```{r probability-distributions-with-8-hint-1, eval = FALSE}
... +
    geom_histogram(aes(y = after_stat(count/sum(count))), 
                   binwidth = 1, 
                   color = "white") 
...
```{r probability-distributions-with-ex-9, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r probability-distributions-with-9-hint-1, eval = FALSE}
scale_x_continuous(breaks = seq(...,..., ...), labels = ...:...) 
```

```{r probability-distributions-with-9-hint-2, eval = FALSE}
... + 
  scale_x_continuous(breaks = seq(2, 12, 1), labels = 2:12) 
```
...
```{r probability-distributions-with-ex-10, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r probability-distributions-with-10-hint-1, eval = FALSE}
... + 
  scale_y_continuous(labels = scales::percent_format(...))
```
...
```{r probability-distributions-with-ex-11, exercise = TRUE}
...
## Probability Distributions With Engine Displacement
### 
...
## Working with Probability Distributions with `rbinom()`
### 
...
```{r working-with-probability-distr-ex-1, exercise = TRUE}

```

```{r working-with-probability-distr-1-hint-1, eval = FALSE}
tibble(heads = ...())
```
...
```{r working-with-probability-distr-ex-2, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r working-with-probability-distr-2-hint-1, eval = FALSE}
...(... = rbinom(n = ..., ... = 10, prob = ...))
```
...
```{r working-with-probability-distr-ex-3, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r working-with-probability-distr-3-hint-1, eval = FALSE}
... |>
  ggplot(...(x = ...))
```
...
```{r working-with-probability-distr-ex-4, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r working-with-probability-distr-4-hint-1, eval = FALSE}
... + 
  geom_bar()
```
...
```{r working-with-probability-distr-ex-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r working-with-probability-distr-5-hint-1, eval = FALSE}
... +
  labs(title = ...,
       subtitle = ...,
       x = ...,
...
```{r working-with-probability-distr-ex-6, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r working-with-probability-distr-6-hint-1, eval = FALSE}
... +
...
```{r working-with-probability-distr-ex-7, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r working-with-probability-distr-7-hint-1, eval = FALSE}
...
```{r working-with-probability-distr-ex-8, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r working-with-probability-distr-8-hint-1, eval = FALSE}
... +
