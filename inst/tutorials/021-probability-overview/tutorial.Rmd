...
<!-- MT: need to replaced nhanes in the book with mpg data  -->
...
```{r 24-two-models-1, exercise = TRUE}

```

```{r 24-two-models-1-hint, eval = FALSE}
tibble(ID = ...)
```
...
```{r 24-two-models-2, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-2-hint, eval = FALSE}
...
```{r 24-two-models-3, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-3-hint, eval = FALSE}
... |>
...
```{r 24-two-models-4, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-4-hint, eval = FALSE}
... |>
  mutate(...,
...
```{r 24-two-models-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-5-hint, eval = FALSE}
jd_disease <- ... 
```
...
```{r 24-two-models-6, exercise = TRUE}

```

```{r 24-two-models-6-hint, eval = FALSE}
... |> 
  filter(... == 1)
```
...
```{r 24-two-models-7, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-7-hint, eval = FALSE}
... |> 
  ggplot(aes(x = ...))
```
...
```{r 24-two-models-8, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-8-hint, eval = FALSE}
... +
    ...()
```
...
```{r 24-two-models-9, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-9-hint, eval = FALSE}
... +
    labs(title = ...,
...
```{r 24-two-models-10, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-10-hint, eval = FALSE}
... +
    scale_x_discrete(... = c(..., ...))
```
...
```{r 24-two-models-11, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-11-hint, eval = FALSE}
... +
    scale_x_discrete(...,
...
```{r 24-two-models-12, exercise = TRUE}
jd_disease |> 
...
```{r 24-two-models-12-hint, eval = FALSE}
jd_disease |> 
  filter(positive_test == 1) |> 
  ggplot(aes(have_disease)) +
    geom_bar(aes(y = ...)))
...
```{r 24-two-models-13, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-13-hint, eval = FALSE}
... +
    geom_bar(aes(y = ...)), 
             color = "white")
```
...
```{r 24-two-models-14, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-14-hint, eval = FALSE}
... +
...
```{r 24-two-models-15, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-15-hint, eval = FALSE}
... +
...
```{r 24-two-models-16, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 24-two-models-16-hint, eval = FALSE}
... +
    scale_y_continuous(labels = ...)
```
...
```{r 27-working-with-prob-1, exercise = TRUE}

```

```{r 27-working-with-prob-1-hint, eval = FALSE}
tibble(heads = ...())
```
...
```{r 27-working-with-prob-2, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 27-working-with-prob-2-hint, eval = FALSE}
...(... = rbinom(n = ..., ... = 10, prob = ...))
```
...
```{r 27-working-with-prob-3, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 27-working-with-prob-3-hint, eval = FALSE}
... |>
  ggplot(...(x = ...))
```
...
```{r 27-working-with-prob-4, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 27-working-with-prob-4-hint, eval = FALSE}
... + 
  geom_bar()
```
...
```{r 27-working-with-prob-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 27-working-with-prob-5-hint, eval = FALSE}
... +
  labs(title = ...,
       subtitle = ...,
       x = ...,
...
```{r 27-working-with-prob-6, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 27-working-with-prob-6-hint, eval = FALSE}
... +
...
```{r 27-working-with-prob-7, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 27-working-with-prob-7-hint, eval = FALSE}
...
```{r 27-working-with-prob-8, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r 27-working-with-prob-8-hint, eval = FALSE}
... +
...
```{r wisdom-2}
question_text(NULL,
	message = "A predictive model in my life can be seen as the money that I will potentially spend on groceries per week. I can take all of the data that I have from the previous weeks to estimate how much I will spend on groceries with a predictive model. Potential Outcome: How much will I spend on groceries?",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Write two sentences explaining a `Causal` model in your life. Include the two potential outcomes and the treatment of the situation. groceries
...
Let's create a `preceptor table` by finding each column needed from the scenario. Write two sentences about what the `ID` is of the situation and how it relates to the scenario.

```{r wisdom-5}
question_text(NULL,
	message = "ID: Citizens. Here we are concerned about each citizen and the data that each one of them will contain.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Why is it credible or not credible for the `assumption of validity` to apply to our situation at hand. Write one reason for the scenario applying to the `assumption of validity` and one reason against that uses the data from immigrants with Spanish-speakers on the train with our scenario of giving citizens a speech to be more kind.

```{r wisdom-9}
question_text(NULL,
	message = "Credible: The treatments are close for the assumption of validity to apply because both scenarios revolve around changing the attitudes of citizens with a change in treatment given to them. 
	           Not Credible: The tretaments are not close for the assumption of validity to apply because one scenario revolves around citizens that are directly interacting with Spanish-speakers, while one scenario revolves around a speech given by the mayor about immigrants.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Write a one sentence summary explaining the concept of `Population Table`.

```{r justice-1}
question_text(NULL,
	message = "It refers to a table that includes both observed and unobserved data for a larger population. The goal is to fill in the missing values, particularly for unobserved potential outcomes.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Let's take the scenario from the last topic and explain how this concept of `Stability` applies in two sentences.

```{r justice-2}
question_text(NULL,
	message = "In this situation, stability applies because of the assumption of validity. We have the same relationship with our data, preceptor table, and the larger population.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Let's take the scenario and explain how this concept of `Representativeness` applies in two sentences.

```{r justice-3}
question_text(NULL,
	message = "Representativeness sadly does not apply to this situation because we do not have a random sample for our data. No matter how hard we try, it will be nearly impossible to maintain the random nature of the population, data, and preceptor table.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Let's take the scenario and explain how this concept of `Unconfoundedness` applies in two sentences.

```{r justice-4}
question_text(NULL,
	message = "Unconfoundedness applies to this situation because we have a causal model at hand. In this scenario we are randomly assigning treatment to the citizens making unconfoundedness apply to our scenario.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
What is the significance of the `Posterior Probability Distributions`, explain in two sentences. 
...
```{r courage-2}
question_text(NULL,
	message = "outcome = model + what is not in the model",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
A `parameter` is something which does not exist in the real world. (If it did, or could, then it would be data.) Since `parameter`s are mental abstractions, we will always be uncertain as to their value, however much data we might collect.
