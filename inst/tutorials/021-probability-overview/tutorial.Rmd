...
author: Yuhan Wu and Mann Talati
tutorial:
...
description: Chapter 2 Tutorial: Probabilitiy
---
...
## 2.2 Probability Distributions With Flipping a Coin 
### 
...
## 2.2 Probability Distributions With Rolling Two Dice
### 
...
## 2.2 Probability Distributions With Engine Displacement
### 
...
## 2.3 List-columns and Map Functions
###
...
## 2.7 Working with Probability Distributions with `rbinom()`
###
...
Here we have a situation in which we are 10,000 times, flipping a unfair coin 10 times. We can see that "Heads" was favored the most throughout the entire flipping.

## 2.8 Cardinal Virtues with Wisdom
...
## 2.8 Cardinal Values with Justice
...
## 2.8 Cardinal Virtues with Courage
...
## 2.8 Cardinal Virtues with Temperance
