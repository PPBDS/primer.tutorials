...
<!-- Virtual shovel culminates in making "Distributions of 1,000 red" -->

<!-- Different sample sizes culminates in Figure 6.7, maybe simpler. Not 100 shovel size. Maybe just 5, 10, 50, 100, 500. -->
...
Let's create the following plot that displays different standard deviations of proportions red for 100 different shovels.
