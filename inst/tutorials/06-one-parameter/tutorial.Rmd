...
<!-- Things to Fix: -->
 ...
 <!-- Read the chapter and see how we have removed the infer package. The sampling is done "by hand" now. Change the exercises below to do the same. This means that functions like use_shovel may not be needed. But prop_red might still be? Key: Make it like the chapter. -->

<!-- DK: Add use of posterior to make a forecast exercise. -->

<!-- DK: geom_col no longer used in first chapter. -->
