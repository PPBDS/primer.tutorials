...
To begin, make sure you are signed in and then go to the GitHub homepage and click on the green new button on the left. 
...
<!-- knitr::include_graphics("www/new_repo.png") -->
<!-- ``` -->
