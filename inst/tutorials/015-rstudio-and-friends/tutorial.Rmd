...
Ensure that Git is installed on your computer. Read the [Install Git](https://happygitwithr.com/install-git.html) chapter in *[Happy Git and GitHub for the useR](https://happygitwithr.com/)*.
...
The next step is creating a GitHub account. Follow [this advice](https://happygitwithr.com/github-acct.html#username-advice) when choosing your username. To do so, follow the steps [here](https://github.com). Do not proceed with the tutorial until you have created an account.
...
Go ahead and create the repository. If you want, feel free to add a description. This is completely optional however.
