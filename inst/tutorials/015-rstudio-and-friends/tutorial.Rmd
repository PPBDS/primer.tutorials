...
Up until now, you have been programming awesome plots on your own computer. But what if you want to share these visualizations and the code behind it to others? Well, that's where tools like GitHub and RPub come in.
...
If you haven't already, create a `projects` folder somewhere on your computer to store your R projects in. We'll be using this folder to keep our R projects organized and separate from the rest of the files on your computer.
...
This should return the folder path of your current project. Every R project is stored in as a folder in your `projects` folder, so you should always be careful to make sure you are in the project folder you are working on.
...
The next step is creating a GitHub account. Follow [this advice](https://happygitwithr.com/github-acct.html#username-advice) when choosing your username. To do so, simply go to the [GitHub mainpage](https://github.com/) and follow their instructions. **Do not** proceed with the tutorial until you have created an account.

### 

Copy your GitHub profile URL in the field below. It should look like "<https://github.com/your-username>".
...
Congrats on creating your GitHub account! GitHub is a must-have tool for programmers and is often the platform for programmer collaborations.
