...
The `new_record` column has been modified to include "Last 3 Days" for the three dots that are the ones we want to highlight. Therefore, we use != to filter out the rows that have nothing.

### Exercise 10

We will now change the colour of those three dots. Open a new mapping argument (outside of the data argument), and set `mapping = aes()`. Within that, set `color` to "#C1392B". 

```{r portlands-heatwave-i-ex-10, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-10-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(data = filter(portland_data, 
                    new_record != ""),
...
```{r portlands-heatwave-i-ex-11, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-11-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(data = filter(portland_data, 
                    new_record != ""),
...
```{r portlands-heatwave-i-ex-12, exercise = TRUE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(color = "none")
...
```{r portlands-heatwave-i-ex-12-hint, eval = FALSE}
...
Next, we will create breaks on the x-axis. You may notice now they simply are numbers. We want to change this to show monthly breaks. However, before we do so, run `months` in the code chunk below. 

```{r portlands-heatwave-i-ex-13, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-13-hint, eval = FALSE}
months
```

###

This `months` tibble contains column `yday`, which indicates what day of the year the months change. The `label` column contains the month name, which we will use to create the breaks in the x-axis.
...
```{r portlands-heatwave-i-ex-14, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-14-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-15, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-15-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-16, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-16-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-17, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-17-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-18, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-18-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-19, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-19-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-20, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-20-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-21, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-21-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-22, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-22-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-23, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-23-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-24, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-24-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-25, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-25-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-26, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-26-hint, eval = FALSE}
ggplot(...) +
  geom_point(...) +
  geom_point(...) +
  guides(...) +
...
```{r portlands-heatwave-i-ex-27, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-27-hint, eval = FALSE}
...
```{r portlands-heatwave-i-ex-28, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-28-hint, eval = FALSE}
...
...
```{r portlands-heatwave-i-ex-29, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-29-hint, eval = FALSE}
...
```{r portlands-heatwave-i-ex-30, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-30-hint, eval = FALSE}
portland_graph + annotate("text",
                          x = 210,
                          y = 118)
```
...
```{r portlands-heatwave-i-ex-31, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-31-hint, eval = FALSE}
portland_graph + annotate("text",
                          x = 210,
                          y = 118,
                          label = "Last 3 days")
...
```{r portlands-heatwave-i-ex-32, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r portlands-heatwave-i-ex-32-hint, eval = FALSE}
portland_graph + annotate("text",
                          x = 210,
                          y = 118,
                          label = "Last 3 days",
