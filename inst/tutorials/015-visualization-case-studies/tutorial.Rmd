...
```{r echo = FALSE}
biden <- ggplot(data = polling_data, 
...
```{r joe-bidens-approval--ex-1, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-1-hint, eval = FALSE}
polling_data
```
...
```{r joe-bidens-approval--ex-3, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-3-hint, eval = FALSE}
...
```{r joe-bidens-approval--ex-4, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-4-hint, eval = FALSE}
ggplot(data = polling_data,
       mapping = aes(x = createddate,
                     y = rate))
```
...
```{r joe-bidens-approval--ex-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-5-hint, eval = FALSE}
ggplot(data = polling_data,
       mapping = aes(x = createddate,
                     y = rate,
                     color = approval_type))
...
```{r joe-bidens-approval--ex-6, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-6-hint, eval = FALSE}
ggplot(data = polling_data,
       mapping = aes(x = createddate,
                     y = rate,
                     color = approval_type)) +
...
```{r joe-bidens-approval--ex-7, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-7-hint, eval = FALSE}
ggplot(data = ...,
       mapping = aes(x = ...,
                     y = ...,
                     color = ...)) +
...
```{r joe-bidens-approval--ex-8, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-8-hint, eval = FALSE}
... + 
  geom_smooth()
```
...
```{r joe-bidens-approval--ex-9, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-9-hint, eval = FALSE}
... + 
  geom_smooth(method = "gam")
```
...
```{r joe-bidens-approval--ex-10, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-10-hint, eval = FALSE}
... + 
  geom_smooth(method = "gam",
              formula = y ~ s(x, bs = "cs"))
```
...
Finally, set se = TRUE.
```{r joe-bidens-approval--ex-11, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-11-hint, eval = FALSE}
... + 
  geom_smooth(method = "gam",
              formula = y ~ s(x, bs = "cs"),
              se = TRUE)
...
```{r joe-bidens-approval--ex-12, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-12-hint, eval = FALSE}
... + 
  geom_smooth(method = ...,
              formula = ...,
              se = ...) +
...
```{r joe-bidens-approval--ex-13, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-13-hint, eval = FALSE}
...+
  scale_y_continuous(labels = scales::percent_format(accuracy = 1))
```
...
```{r joe-bidens-approval--ex-14, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r joe-bidens-approval--ex-14-hint, eval = FALSE}
... +
  labs(title = ...,
       subtitle = ...,
       color = ...,
