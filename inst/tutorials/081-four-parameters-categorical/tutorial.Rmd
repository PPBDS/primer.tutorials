...
<!-- DK: Discuss in various places that, unlike usually, the data comes after the Preceptor Table. So the Population Table looks different. Done. -->

<!-- DK: Also discuss how post-hoc survey data can be unreliable. Validity concern is that who you say you voted for is not the same as who  Done.-->

<!-- DK: Fix up the template tutorial to handle multinomial. Done.-->
...
<!-- IS: tutorial says to run predictions() and avg_comparisons, but won't work on multinomial. -->

### Exercise 7

<!-- DK: Change to "Run `plot_predictions()` on `fit_nes` with arguments . . .  Done. -->
