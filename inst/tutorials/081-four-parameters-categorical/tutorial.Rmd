...
Pipe **summarize** to nes, set the **.by** argument to **sex**
...
```{r wisdom-11-hint-4, eval = FALSE}
nes |> ...
```

```{r wisdom-11-hint-5, eval = FALSE}
nes |> summarize(...)
```
...
```{r wisdom-14}
question_text(NULL,
	message = "People may claim that they voted for one candidate when they really voted for another. This causes the data in the population table to not line up with the columns in the Preceptor Table",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
