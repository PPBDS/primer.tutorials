...
<!-- DK: Maybe add a show_file() question at the end? -->
...
<!-- TJ: Will expand on this explanation. Summarised it and made it shorter and more concise. Explained when to use add_epred_draws. Done -->
...
<!-- TJ: Where do I get the data on the QoI. There is nothing in the chapter that tells what this is. -->
...
<!-- DK: Publish after the switch of the material. Done -->
