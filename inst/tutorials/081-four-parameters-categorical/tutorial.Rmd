...
```{r justice-6}
question_text(NULL,
	message = "The assumption of representativeness might not be true because the sample of our data and Preceptor Table are not random enough.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Create a new code chunk with`#| label: model` and `#| cache: TRUE` at the top. Copy and paste the code from exercise 2 here. Render the document.


In the console, run `tutorial.helpers::show_file("analysis.qmd", start = -8)`
...
It should've taken you a while to run this code. But, since we added `#| cache: TRUE` at the top, from now onwards it will be a lot quicker. Render it again and observe the difference.
