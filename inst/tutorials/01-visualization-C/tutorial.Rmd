...
Note that this theme does not omits axes labels. Do you think it worth it?
...
`plotly` allows us to make interactive graphs. It is especially useful with `geom_point()`. Hover over the points to see more information about them.
