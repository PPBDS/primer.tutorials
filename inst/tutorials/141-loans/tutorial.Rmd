...
# works with everything and marginaleffects is also ecumenical. equatiomatic can
# be more fussy.
...
fit_loans_model <- rand_forest(mode = "regression", engine = "ranger", mtry = 8, trees = 100, min_n = 17) 
