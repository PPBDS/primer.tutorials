...
<!-- Complete the tutorial yourself. Email me the answers. In your email, discuss what you think about the current Cardinal Virtues section. -->

<!-- Add test chunks. -->

<!-- Fix all the typos and ugliness. -->

<!-- Make comments about sections to cut. -->

<!-- Use best practices, especially make a plot at the start of the topic, assign it to something_p. Then, build the plot line-by-line. Then, last question "Recall that the plot looks like this" and show something_p. Three Models topic already does this. -->

<!-- ? Make Cardinal Virtue section consistent with https://ppbds.github.io/primer/key-concepts.html.  -->
...
Within `summarise()`, add a new argument separate by comma, `middle`, and set it equal to the median of `numbers` using `median()`.
...
Within `summarise()`, add a new argument separate by comma, `stan_dev`, and then set `stan_dev` equal to the standard deviation of `numbers` using sd(). Recall standard deviation is measuring how spread out our numbers are.
...
Within `summarise()`, add a new argument separated by comma, `med_dev`, and set mad equal to the median absolute deviation of `numbers` using `mad()`. 
...
```{r pds-with-flipping-a-coin-1, exercise = TRUE}
...
```{r pds-with-flipping-a-coin-2, exercise = TRUE}
...
```{r pds-with-flipping-a-coin-3, exercise = TRUE}
...
```{r pds-with-flipping-a-coin-4, exercise = TRUE}
...
```{r pds-with-flipping-a-coin-5, exercise = TRUE}
...
```{r pds-with-flipping-a-coin-6, exercise = TRUE}
...
```{r pds-with-flipping-a-coin-7, exercise = TRUE}
...
```{r pds-with-flipping-a-coin-8, exercise = TRUE}
...
```{r pds-with-rolling-two-dice-1, exercise = TRUE}
...
```{r pds-with-rolling-two-dice-2, exercise = TRUE}
...
```{r pds-with-rolling-two-dice-3, exercise = TRUE}
...
```{r pds-with-rolling-two-dice-4, exercise = TRUE}
...
```{r pds-with-rolling-two-dice-5, exercise = TRUE}
...
```{r pds-with-rolling-two-dice-6, exercise = TRUE}
...
```{r pds-with-rolling-two-dice-7, exercise = TRUE}
...
```{r pds-with-rolling-two-dice-8, exercise = TRUE}
...
```{r pds-with-rolling-two-dice-9, exercise = TRUE}
...
```{r pds-with-rolling-two-dice-10, exercise = TRUE}
...
```{r pds-with-rolling-two-dice-11, exercise = TRUE}
...
```{r pds-with-engine-displacement-1, exercise = TRUE}
...
```{r pds-with-engine-displacement-2, exercise = TRUE}
...
```{r pds-with-engine-displacement-3, exercise = TRUE}
...
```{r pds-with-engine-displacement-4, exercise = TRUE}
...
```{r pds-with-engine-displacement-5, exercise = TRUE}
...
```{r pds-with-engine-displacement-6, exercise = TRUE}
...
```{r pds-with-engine-displacement-7, exercise = TRUE}
...
```{r pds-with-engine-displacement-8, exercise = TRUE}
...
```{r working-with-pds-with-rbinom-1, exercise = TRUE}
...
```{r working-with-pds-with-rbinom-2, exercise = TRUE}
...
```{r working-with-pds-with-rbinom-3, exercise = TRUE}
...
```{r working-with-pds-with-rbinom-4, exercise = TRUE}
...
```{r working-with-pds-with-rbinom-5, exercise = TRUE}
...
```{r working-with-pds-with-rbinom-6, exercise = TRUE}
...
```{r working-with-pds-with-rbinom-7, exercise = TRUE}
...
```{r working-with-pds-with-rbinom-8, exercise = TRUE}
