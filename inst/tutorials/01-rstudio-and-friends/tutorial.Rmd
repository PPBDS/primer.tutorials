...
Copy and paste (or type) `rstudioapi::readRStudioPreference(name = "load_workspace", default = "Code failed.")` into the console, then copy and paste both the command and the result into the space below. It should return FALSE.
