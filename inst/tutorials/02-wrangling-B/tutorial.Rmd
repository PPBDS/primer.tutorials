...
<!-- scale_fill_brewer(), coord_cartesian(), and  scale_linetype() all have no explanation in primer. DK: So, don't use them. Or give a clearer hint. -->

<!-- DK: See below for problems with qscores question. Ignore this for now. -->
...
<!-- NL: Is there a reason we are using gam over loess for geom_smooth. I don't think gam is in the textbook? -->
...
Using `summarize()`, calculate `mean_change_in_expenses`, the` mean()` of the `change_in_expenses` for each group. Set `.groups` = "drop".
