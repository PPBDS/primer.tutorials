...
Use `str_subset()` to find `state.name` that contain the letter "n" . The first argument to `str_subset()` should be `state.name` . The second argument should set `pattern` to "n".
...
Use `str_subset()` to identify all states that have an "i", followed by any single character, followed by "a".  The first argument to `str_subset()` should be `state.name` . The second argument should set `pattern` to "i.a".
...
Now use `str_subset()` to identify all states that end in g. The first argument to `str_subset()` should be `state.name` . The second argument should set `pattern` to "g$".
