...
Good! You should see that we are looking at a general dataset on diamonds, their price, carats, and their cuts.
...
```{r geompoint-with-size-5-hint-2, eval = FALSE}
... %>% 
  ggplot(mapping = aes(x = ..., 
                       y = ..., 
                       color = ...)) +
...
```{r geompoint-with-size-8-hint-2, eval = FALSE}
... + 
  scale_x_log10()
```
