...
<!-- Here is what we are doinga nd why you should care. Maybe key links? -->
...
```{r geompoint-17-hint-2, eval = FALSE}
...  +
  ggplot(mapping = aes(x = ..., y = ... )) +
  geom_point(alpha = ...) +
  facet_wrap(~ gender) +
...
```{r geompoint-18, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geompoint-18-hint-1, eval = FALSE}
... +
  labs(title = "...",
       subtitle = "... \n ...",
       x = "...",
...
<!-- Conclude with two sentences which remind me why I enjoy spending time with you! -->
