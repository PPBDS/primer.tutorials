...
<!-- Change everything you hate! You own this tutorial. Take ownership. Change anything you like. What are the most important skills to practice? -->


<!-- Every Section starts with 1 or 2 or 3 data exploration questions to start of each new plotting. ?trains, view(), glimpse(), summary() and whatever.  -->
...
Run `?nhanes` to look more in-depth at the `nhanes` dataset. 
...
### Exercise 4
Run `view()` on the `nhanes` dataset to view the data as a tibble.
...
Using formula y~x lets R know there is a linear relationship between y and x values on your graph.
<!-- Not entirely sure about this: check with Preceptor -->
