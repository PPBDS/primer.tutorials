...
<!-- VD: Not sure how to go about confirming this if we are not saving yet.-->
...
The `5 * 5` should have run in your Console, as well as it's return value `25`. Whenever you run an R Script file, it will run selected code in the R Console.
...
First off, let's create an R Markdown file. Click the dropdown menu at the top left. Click "R Markdown". Name the file `markdown1`

```{r}
include_graphics("images/new_markdown.gif")
```

<!-- VD: Not sure how to check that they have created a markdown without saving it. -->
