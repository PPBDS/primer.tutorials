...
Create an R script by clicking the drop down menu at the top left of your R Studio Session, and selecting "R Script".
...
If you are prompted to update, follow the steps to download the latest version of RStudio. If not, you're good to go!
...
Render the `quarto-2` document. By rendering, you are generating a report written in HTML, which is what RPubs publishes on the web.
