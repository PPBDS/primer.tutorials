...
It would also be a good idea to to store this folder on your desktop, so that it can be found easily.
...
<!-- DK: Switch to "analysis-1" from "project1". -->
