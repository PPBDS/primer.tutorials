...
There is an easier way to look at the whole document, though.

### 

We will switch between "Source" and "Visual"

### Exercise 4

We will be exploring the "Visual" setting in the Quarto Document. In the top left corner or your screen, you should be able to see two buttons labeled "Source" and "Visual". It should look like this:

```{r}
include_graphics("images/Source_visual.png")
```
