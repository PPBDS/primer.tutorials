...
Click on the dropdown menu at the top right of your R Studio Session. Then click "New Project". 
...
Recall the "Getting Started" tutorial, where we saw the "Terminate Jobs" warning. Remember that continuing here will close this tutorial.
