...
Remember the **iris** graph that we made? We are going to include that in the Quarto Document along with the Harvard graph that we made. First, we need to save the graph to an object.

### 

Go back to the `quarto-1` document and copy and paste the code for the iris plot into the `quarto-2` document into a new code chunk named `iris`.
...
Now that you have the code for the iris plot in your document, we are going to save it to an object. Call the ob
