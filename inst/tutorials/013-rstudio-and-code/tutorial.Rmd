...
We are going to make a fake setup chunk, because Quarto does not have setup chunks, where you can load all the libraries you need. Add a new code chunk with the green C at the top of the page.

### 

Any good Data Scientist includes names in their code chunks, that way they are easier to distinguish from one another.
