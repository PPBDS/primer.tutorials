...
In the [Getting Started section](https://ppbds.github.io/primer/getting-started.html) of the *Primer*, you should have installed the **remotes**, **tidyverse**, **usethis**, and **primer.tutorials** packages.
...
<!-- DK: Mention constant not function. -->
...
<!-- Add a more detailed explanation for windows computers -->
...
<!-- Add Image Here. Expand on this process. -->
