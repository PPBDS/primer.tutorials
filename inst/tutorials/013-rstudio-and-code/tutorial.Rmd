...
render the file to see our completed graph.
...
render the file, then in the console, type `x` to verify that x has been defined. Copy-paste the command and the output below.
