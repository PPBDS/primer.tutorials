...
There are several ways to interact with an R script. The first, as you have done above, is to just hit the "Run" button. The second is to place your cursor in the R script window and hit 
