...
First, let's check whether you have the appropriate files in your project. Run `list.files()` in the Console (same instance as your project). Paste the result in the box below.
...
In the Console, run `show_file("index.qmd")`. CP/CR.

(Obviously, for `show_file()` to run you need to have loaded the **tutorial.helpers** package in your R session.)
