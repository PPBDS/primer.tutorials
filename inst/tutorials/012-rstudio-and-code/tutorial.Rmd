...
We'll be publishing our Quarto documents on the Internet by using [Quarto Pub](https://quartopub.com/)

### Exercise 1

First, we need to make an account. Go to 
the Quarto Pub [Website](https://quartopub.com/).

###

Click the big blue button that says "Sign Up For Quarto Pub", and use your new github username and password.

###

Now, you should have an account, so we can publish.

### Exercise 1

Render the `quarto-1` and `quarto-2` files. By rendering, you are generating a report in HTML, which is what Quarto Pub publishes on the web.
