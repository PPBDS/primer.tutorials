...
exp_dist_diff <- pp %>% 
  ...
  labs(title = "Posterior for Expected Distance Difference",
       subtitle = "The expected difference of average distance between polling locations with poverty rates of 0.5 and 0.8 is about 20 km",
       x = "Poverty Rate",
       y = "Probability") +
  scale_y_continuous(labels = scales::percent_format()) +
  theme_classic()
...
exp_dist_diff_2 <- pp %>% 
  ...
  geom_histogram(aes(y = after_stat(count/sum(count))),
                 bins = 100) + 
  labs(title = "Posterior for Expected Distance Difference",
       subtitle = "The expected difference of average distance between polling locations with poverty rates of 0.5 and 0.8 is about 5 km",
       x = "Poverty Rate",
       y = "Probability") +
  scale_y_continuous(labels = scales::percent_format()) +
  theme_classic()
