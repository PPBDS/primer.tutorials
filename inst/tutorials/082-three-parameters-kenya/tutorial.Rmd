...
exp_poverty <- pe %>%
  ...
  labs(title = "Posterior for Expected Distance",
       subtitle = "Polling locations that are on average 12 miles from those assigned to them have poverty rates of 0.2",
       x = "Poverty Rate",
       y = "Probability") +
...
Through this, we have determined that we expect polling locations which are 12 miles away on average from those who are assigned to that location to have a poverty rate of 0.2, and achieved this answer with data that we considered to be pretty representative.

## Non-Representative Data

In our last model, we could consider our data to be representative of our population, however, what if that were not the case? Now, let's answer the same question, but with unrepresentative data. Recall our question.
