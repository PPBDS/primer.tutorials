...
Let's publish our project onto the internet again using [Quarto Pub](https://quartopub.com/).
...
Just like we did in Rstudio and Code, we are going to type `quarto publish quarto-pub` in the Terminal. This should publish to Quarto Pub. Put the URL of your 
