...
Just like we did in Rstudio and Code, we are going to type `quarto publish quarto-pub` in the Terminal. This should publish to Quarto Pub. Put the URL of your website below:
...
Nice work! You've created another Quarto Pub page and your changes should be saved to GitHub.
