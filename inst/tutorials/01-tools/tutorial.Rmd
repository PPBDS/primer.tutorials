...
Let's figure out where we are. To see your current location, type `pwd` (present working directory), in the Terminal. Hit return, and copy/paste both the line on which you typed the command and the line below it.
