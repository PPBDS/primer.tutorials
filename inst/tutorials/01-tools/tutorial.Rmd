...
The Terminal pane is next to the Console pane in the lower left portion of RStudio. We use the Console pane to talke to R. We use the Terminal pane to talk directly with your computer. Sadly, the Console and the Terminal speak different languages.
