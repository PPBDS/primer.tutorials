...
This tutorial covers material in the first three parts of the Appendix on [Tools](https://ppbds.github.io/primer/tools.html): "Working with the terminal," "Git, GitHub, and RStudio," and "PDF." 
...
Let's figure out where we are. To see your current location, type `pwd` (present working directory), in the Console. Hit return, and copy/paste both the line on which you typed the command and the line(s) below it.
...
Let's try making a folder called Gov-1005. Use the command `mkdir Gov-1005`and hit return. Now type `ls` to see your newly created folder! Paste both the line on which you typed the command and the line(s) below it.
...
Now let's move our text.txt file to our Gov-1005 folder. Type `mv test.txt Gov-1005/`. Now let's check! Use `cd` to open our Gov-1005 folder and `ls` to show its contents. Paste both the line on which you typed the command and the line(s) below it
...
Try copying the test.txt file into your Gov-1005 folder. Use `cp test.txt Gov-1005/`. Paste both the line on which you typed the command and the line(s) below it.
