...
For RStudio to make PDF files, your computer must be set up with a LaTeX. Open up your Console, and install the package 'tinytex' using `install.pacakges()`. Copy/paste both the line on which you typed the command and the line(s) below it
