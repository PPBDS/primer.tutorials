...
No more "Good work." Drop some knowledge. 
Mention some functions. (Example: geom_col().) 
Mention some arguments (like binwidth for geom_histogram). 
Mention issues associated with your code, like with values in your arguments. Example: color = "steelblue". Where did that color name come from? Where can I read more about colors in R? Where can I look up all the color names I can play with?  -->
