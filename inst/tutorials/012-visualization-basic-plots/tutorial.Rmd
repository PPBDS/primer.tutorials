...
description: Simple tidyverse introdution and an overview of basic plots.
---

<!-- Tutorial should take about 90 minutes. -->

<!-- Remove str(). Use glimpse() and summary(). -->

<!-- Show jitter plot at beginning of geom_jitter(). Same with other sections. KX: || DONE -->

<!-- Use a new data set for geom_smooth(). -->

<!-- Split up Sections into more questions. For example, geom_smooth(method = "lm", formula = y ~ x, se = FALSE) should be 4 Exercises.  -->
