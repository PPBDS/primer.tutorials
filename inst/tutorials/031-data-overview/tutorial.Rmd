...
```{r web-scaping-examples-6-hint, eval = FALSE}
...
```{r web-scaping-examples-7-hint, eval = FALSE}
... |> 
  html_table("...")
```
...
```{r web-scaping-examples-8-hint, eval = FALSE}
... |> 
  html_table()
```
...
```{r web-scaping-examples-9-hint, eval = FALSE}
... |> 
  select(
...
```{r web-scaping-examples-10-hint, eval = FALSE}
... |> 
  mutate(
...
```{r web-scaping-examples-11-hint, eval = FALSE}
... |> 
...
```{r web-scaping-examples-12-hint, eval = FALSE}
... |> 
...
```{r web-scaping-examples-13-hint, eval = FALSE}
"https://www.imdb.com/chart/top" |> 
  read_html() |> 
  html_element("table") |> 
  html_table() |>   
