...
In this tutorial, you will learn how to create a distill website, and modify it. This is what we will be using to create our final project!
...
Read the instructions below carefully because your tutorial will close after this.

###

Back in the RStudio session from which you are running this tutorial, click File -> New Project -> Version Control -> Git and copy and paste your url into the "Repository URL". Click "Create Project" and reopen this tutorial from the new "distill-tutorial" project. 

### 

In the Terminal, run `pwd` to confirm that you are in the correct directory, i.e. a directory named `distill_tutorial` in the place you normally keep R projects. Copy and paste the command and result below.
...
To set up and manage the files needed to create a website with R Markdown files, we use the package `distill`. In the Console, use the `library()` function to load the package. 

### 

To confirm that you have successfully installed and loaded the package run the function `search()` in the console. Copy/paste the output below. 
...
If you do not, close and then re-open R Studio (this will close the tutorial, just reopen it). You should now see a Build tab.

### Exercise 7

In `index.Rmd`, replace the example description with the string "This is where I will describe my final project." Knit this file. This opens a preview of what this page of the website will look like.
...
**Note: Whenever you click "build website" the tutorial will close so you will have to reopen it.**
