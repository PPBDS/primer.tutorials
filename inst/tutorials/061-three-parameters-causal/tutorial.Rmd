...
# It seems like a huge bug, or at least a poorly documented API, that we need
# $fit. Can't extract_eq() just look for the fit object?

# extract_eq(fit_att$fit, intercept = "beta")
# extract_eq(fit_att$fit, intercept = "beta", use_coefs = TRUE)
# 
# plot_predictions(fit_att$fit,
#             newdata = "balanced",
#             condition = "treatment")
...
<!-- DK Add sentence about this: The last two sentence kind of use fancy wording, can we make it simpler to understand? *from template tutorial -->
...
<!-- SU: I didn't know what to add here, but pls check if its accurate DK: Check the template.-->
