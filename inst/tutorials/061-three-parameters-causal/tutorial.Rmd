...
<!-- DK: This won't work when we paste to the QMD because ndata is not defined in the QMD. So, we either need to define it there or put the raw `tibble()` code in as the `newdata` argument. -->
