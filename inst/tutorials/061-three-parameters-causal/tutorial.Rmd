...
```{r the-question-6}
question_text(NULL,
	message = "There are 2 potential outcomes because the treatment variable exposure to Spanish speakers takes on 2 posible values: list-the-values-here, i.e., exposure to Spanish-speakers on a train paltform versus no such exposure.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
<!-- SU: Clarification on this, I'm confused on what to substitute. -->
...
<!-- SU: This was supposed to be the wsidom drop, but makes no sense. Clarify. -->
...
Any causal connection means exploring the difference between two potential outcomes. We don't need to look at any other rows to have that conversation.
