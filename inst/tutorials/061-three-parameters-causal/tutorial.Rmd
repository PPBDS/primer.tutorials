...
<!-- DK: Next question should use select(treatment, .draw, .epred) -->
...
<!-- Add a question or two about what 1.5 means. Start a new pipe with trains.Then select (att_end, party, treatment). Third, filter treatment == Control. Use summarize .by party. -->
...
<!-- DK: Wider confidence interval needed -->
