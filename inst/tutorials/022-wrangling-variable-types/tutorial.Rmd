...
<!-- AM: Don't other tutorials prompt you to answer the question if you haven't already run something in the code chunk? I don't recall which tutorials have this but I'd like it to be in this tutorial as well. -->
...
<!-- This button does not appear to do anything. -->

<button onclick = "transfer_code(this)">Copy previous code</button>

<!-- AM: Why does the word "in" show up in blue? Can something be done about this? -->
...
<!-- AM: Should there be a button navigate between hints? Right now you can only move to the second hint and can't come back to the first. -->
