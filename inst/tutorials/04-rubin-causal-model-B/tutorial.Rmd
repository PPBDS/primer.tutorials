...
include_graphics("images/Answer_Rubin_Causal_Model_B_Two_Taus_ex_1.png")
```
...
include_graphics("images/Answer_Rubin_Causal_Model_B_Two_Taus_ex_2.png")
```
...
include_graphics("images/Answer_Rubin_Causal_Model_B_Two_Taus_ex_4.png")
```
...
```{r Answer_ATE_ex_1}
include_graphics("images/Answer_Rubin_Causal_Model_B_Average_Treatment_Effect_ex_1.png")
```
...
```{r Answer_ATE_ex_4}
include_graphics("images/Answer_Rubin_Causal_Model_B_Average_Treatment_Effect_ex_4.png")
```
...
```{r Answer_ATE_ex_5}
include_graphics("images/Answer_Rubin_Causal_Model_B_Average_Treatment_Effect_ex_5.png")
```
...
include_graphics("images/Answer_Rubin_Causal_Model_B_Causal_vs_Predictive_Models_ex_1.png")
```
