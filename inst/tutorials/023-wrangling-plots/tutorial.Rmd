...
<!-- ROAS plots about percentage accounted for by top 10 names and last letter in boys names. 
...
<!-- DK: Never have , warning=FALSE. Fix the thing which is causing the warning. -->
...
sps_p <- sps %>%
  ...
  # DK: Change the x-axis order so that it is in order of education.
  
  # The treatments are not really 0 and 1!
