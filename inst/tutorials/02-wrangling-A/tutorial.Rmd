...
Run the following code: `x <- read_csv("https://raw.githubusercontent.com/lawanin/PA-policing-data/master/philly-clean.csv", col_types = cols())`. This downloads data on 2016 PA police complaints and saves it to an R object named `x`. For your convenience, this code will be included in all the following exercises. 
