...
CSV files are one type of **text** file. A text file is any file which include plain text. A file whose contents are easy to look at in any text editor, or in RStudio.
...
```{r tab-1, exercise=TRUE}

```

```{r tab-1-hint, eval = FALSE}
