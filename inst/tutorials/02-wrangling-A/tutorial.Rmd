...
Write code for reading this file in to R, using the tricks you used in the previous question. Also, use the `col_types` argument to both prevent the col_types message from printing out and to set `population` as an integer.
