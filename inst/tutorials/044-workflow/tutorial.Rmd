...
<!-- This tutorial has potential, but it is currently quite a mish-mash of material. When should we teach it? Best approach is to turn it into something which is assigned in week 4, probably for Wednesday. There is lots of good stuff here and we should assign some more work in week 4 anyway. Moreover, in the semester class case, week four has lots of room for work. -->
