...
Let's first `view()` the data set used above called `iris`. Can you identify which columns will be relevant in creating our plot?
...
ggplot(data = iris, 
    ...
    geom_point()
```
<!-- KX: Consider creating hint directing to primer -->
### Exercise 3
