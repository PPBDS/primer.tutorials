...
We will know create a plot with the `trains` dataset to implement this solution to overplotting. 

### Exercise 2

To better understand the data, read into the dataset by running `?trains`.
...
Run `view(trains)` to further explore the data. Take notice of the integer values for `att_start` and `att_end`.
...
### Exercise 1
As always, let's first explore the 
