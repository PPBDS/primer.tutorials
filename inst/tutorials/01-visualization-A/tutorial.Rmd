...
<!-- NL: Thoughts- A. Combine first two sections to create section that starts with vectors and builds towards understanding a data frame columns as vectors. Students should make their own tibble? B. Combine geom_point(), geom_jitter(), and geom_smooth(), have students understand more about aes by demonstrating fill with data vs with color. C. Combine geom_bar(), geom_histogram(), and geom_density(), introduce aes(y = after_stat(count/sum(count))) as transition from histogram to density and development. Yes! But not this week. --> 
