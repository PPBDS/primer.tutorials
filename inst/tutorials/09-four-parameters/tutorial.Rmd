...
<!-- For this section, there is a lot of manipulated variables like liberal_false_intercept. Should I have them first create all those then proceed to guide students through the plot (A "preliminaries" section almost) OR should I just have the students make the plot with the manipulated variables already existing in the workspace? -->

## Temperance
###

<!-- There is no Temperance section in the Primer. What are some Temperance-like questions we could do here? One could be how would the att_end vary for a non liberal and liberal with the same att_start value? Should we only do one question here or two? The second could show by how much it varies? -->
