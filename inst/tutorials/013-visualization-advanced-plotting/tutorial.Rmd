...
```{r}
polling_data <- read_csv("inst/tutorials/013-visualization-advanced-plotting/data/vis4_polling_data.csv",
...
# YW: inst/tutorials/013-visualization-advanced-plotting/data/vis4_polling_data.csv work but when Run Document not working.
# YW: Safe way is prob to add to primer.data
```
