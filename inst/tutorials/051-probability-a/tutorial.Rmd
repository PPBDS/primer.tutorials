...
<!-- Stop writing stuff like "Copy/paste your code from above." This is implicit, given the copy button. -->
...
<!-- Delete all these questions. Only use things that map to the current version of the chapter. -->
...
Create a tibble with a column `x`.  Have `x` take on the values 3,7,2,8, and 4. 
...
Assign your work to an object named `tbl_x`. 
