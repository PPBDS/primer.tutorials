...
Congrats! You just downloaded your first Census data from the Decennial Census.
...
<!-- DK: First question should be library(tigris) -->
...
**When using tigris, use `options(tigris_use_cache = TRUE)` so it doesn't take forever to download data.** Don't worry about it in this tutorial, but keep this in mind when working on your own. 
