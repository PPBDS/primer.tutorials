...
Run `usethis::edit_r_profile()` in the console. Then put `options(tigris_use_cache = TRUE)` in your `.Rprofile` file. Type "done" in the box below when you finish. 
...
Now whenever your R session opens, it will make sure this setting is on.
