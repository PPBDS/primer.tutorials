...
When working with text files like `.gitignore` it is wise to ensure that the last line of the file is blank. This generally does not matter but, when it does, chaos can ensue.
...
In the distill-tutorial R Studio instance, open index.Rmd, which should be in the same directory as the .Rproj for your website. In the setup chunk, load the library `tidyverse` and the library `ggthemes`. 
