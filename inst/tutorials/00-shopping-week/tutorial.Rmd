...
Be careful about cutting and pasting code from elsewhere into tutorials. In general, *this will not work!* As an example of it not working, copy/paste the first `gapminder` plot from the [Basic Plots](https://ppbds.github.io/primer/visualization.html#basic-plots) section of *The Primer* and then hit "Run Code."
...
This should report an error like "object 'gapminder' not found" since we have not loaded the **gapminder** package.
