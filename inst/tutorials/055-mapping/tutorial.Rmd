...
#                  state = state.name[! state.name %in% c("Alaska", "Hawaii")],
#                  variables = "B02001_008", 
#                  year = 2018,
#                  summary_var = "B02001_001",
#                  geometry = TRUE)
# write_rds(races_data, "data/05-mapping-races-data.rds")

races_data <- read_rds("data/05-mapping-races-data.rds")
view(races_data)
```
...
Create a new variable called `continental` that 
...
And here we encounter one of the main problems in dealing with big data: **it takes a massive amount of time**. Even if you had a supercomputer, we're quite literally downloading 
