...
<!-- Experimented with several things including RapidAPI, but to little / no avail -->

### Exercise 1

```{r eval = FALSE}

# this is example code created by `rapidapi` - I can't get it to behave
...
response <- VERB("GET", url, 
                 add_headers(x_rapidapi-key = 
                               'e74658ae25msh79ada6e78af34c6p163bc6jsn6e11ab5d4ae8',
                               x_rapidapi-host = 'covid-19-data.p.rapidapi.com'),
