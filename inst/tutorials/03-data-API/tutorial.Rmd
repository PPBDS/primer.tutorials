...
In the Tutorial interface, `writeBin()` does not actually write a file on your computer. If you want to be able to perform the following command, repeat the instructions above on your console. If not you can access a copy of the HTML file which we have already saved [here]()
...
Start a new pipe with `imf_data_named`. Rename the column `GGXWDG_GDP` to `dtg`.
