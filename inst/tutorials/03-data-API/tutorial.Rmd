...
```{r wb_setup, eval = FALSE, echo = FALSE}
ratio <- WDI(
  country = "all",
...
World Bank Data: the **WDI** package. This API application benefits from having a package built around it. You can learn more about the package [here](http://vincentarelbundock.github.io/WDI/). 
