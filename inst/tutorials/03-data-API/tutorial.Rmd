...
Rename the wage ratio column to be `wage_ratio`, then drop NA values from the `wage_ratio` column. Be sure to reassign this change to `ratio`. 
...
With the ability to analyze the change in a country over time, create a scatter plot that shows changes in the spread across countries over time.
