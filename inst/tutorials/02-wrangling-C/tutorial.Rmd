...
Adjust the feel of the graph by adding the theme `theme_clean()`. To finish your plot, use `labs()` to give the graph a title, subtitle, axis labels, legend heading, and caption. To use a quotation marks in labels, such as in our example with "Introduction", enclose the whole string in single quotes instead of double quotes. 
