...
We have provided you with the beginning of code for the last plot. Continue your pipe with `ggplot()`.  Map `age` to the x-axis, `vote_sum` to the y-axis, and `primary_06` to `color`. Add the layer `stat_pointinterval()`.
