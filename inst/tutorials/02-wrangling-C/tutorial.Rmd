...
## Michigan Voter Experiment {#michigan}
###
...
```{r shaming23, exercise = TRUE}

```

```{r shaming23-hint-1, eval = FALSE}
... +
  theme_classic()  +
  labs(... ,
     fill = "...",
...
```{r col-8-hint-1, eval = FALSE}
Within facet_wrap(), remember to put a ~ before the variable you want to facet by.
```

```{r col-8-hint-2, eval = FALSE}
... + 
  facet_wrap(...) 
```
...
```{r col-9, exercise = TRUE}

```

```{r col-9-hint-1, eval = FALSE}
... +
...
```{r col-10, exercise = TRUE}

```

```{r col-10-hint, eval = FALSE}
... +
  theme_classic() 
```
...
```{r col-11, exercise = TRUE}

```

```{r col-11-hint-1, eval = FALSE}
... +
  labs(... ,
     fill = "...",
     ...)
