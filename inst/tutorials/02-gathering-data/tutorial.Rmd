...
# For some usage, you want to interact with the file in its main collection,
# without copying it over. For that purpose, you need the path to where the
# package is installed.

www <- system.file("www/", package = "primer.tutorials")
...
```{r ex-1-setup}
file.copy(paste0(www, "test_1.csv"), ".")
```

Consider the contents of the `test_1.csv` file. 

```{r, comment=''}
cat(readLines(paste0(www, "test_1.csv")), sep = "\n")
```
...
```{r}
read_csv(paste0(www, "test_1.csv"),
