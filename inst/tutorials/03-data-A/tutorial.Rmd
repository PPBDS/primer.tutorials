...
When a file is parsed, **readr** reads the first 1000 rows of each column and uses some (moderately conservative) heuristics to figure out the data type of each column. 
...
Sometimes the defaults **reader** generates don’t always work for larger files. Run the following code chunk to see parsing failures.
