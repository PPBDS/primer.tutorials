...
We're also going to be working from a *blank slate* for our R projects. This means that R won't store information between restarts, making it much easier to create reproducible analyses because junk from previous sessions can't affect your current session. While you should have done this in the Getting Started tutorial, we will ensure that you do it again. 
...
This should return the file path of your current project. Remember to always check what working directory you are in, as projects later on will require you to refer to images stored in different folders, and for that we need relative paths dependent on where our current working directory is.
...
We'll be creating a similar graph later in in the Visualization A tutorial.
