...
<!-- Case studies start from scratch. Often, the first exercise is something like, make a repo (you (Anmay) determine the name), connect to your computer. Then run list.files() and copy/paste the output. Second question, create an Rmd (or R or whatever) with a name you specify. DONE -->
...
<!-- AG: Image is a little bit small, I'll replace it later. -->
...
<!-- AG: Image is weird, need to change to get rid of the `push` arrow. -->
...
<!-- AG: I should probably include the information on how to pull from gists, but it's the same thing as a normal repo so it's kind of iffy. -->
