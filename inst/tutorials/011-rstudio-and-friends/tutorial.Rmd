...
Run `usethis::edit_r_environ()` in the Console to open your `.Renviron` file. If you can't open the file, it's likely due to you using OneDrive or a cloud drive service to store your projects. **Please store your 
...
<!-- I do not explain knitting very well right here. It needs to be improved or at least explained further in the primer somewhere. DONE -->
...
This should contain the text that you created in this exercise as well as the previous text.
...
And here's what the R Markdown file looks like:
...
<!-- AG: I'm contemplating relocating this section to the GitHub section since that area actually deals with GitHub. Not at this stage though since the current structure only has 1 case study. It's staying here as it acts as the publishing method for R scripts. -->
...
<!-- AG: I'm not elaborating because it feels too long and we haven't even explained how to fork and everything in a normal repository, nevermind why a gist is different. Adding final GitHub repo -->
...
<!-- AG: Just wanted to add this since it distinguishes the gist from a github repo. The transition sucks but it's still an extremely common use of gists. It's ok - DONE -->
