...
First off, we need to download the **gistr** package. This is what we're going to use in order to create gists using R. While you can create gists through GitHub, using **gistr** allows you to better see the process in motion and better control what you want to upload into your gist (and it's a lot quicker).
