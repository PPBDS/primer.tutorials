...
This tutorial covers [Chapter 1](https://ppbds.github.io/primer/04-rubin-causal-model.html) of Preceptor's Primer. This tutorial will review a Preceptor Table, Population Table, Causal Effect, Simple Models (One tau & Two taus) and Assumptions (Validity, Stability, Representativeness, & Unconfoundedness).
...
<!-- MT: what else can be added here? -->
...
This tutorial covered [Chapter 1](https://ppbds.github.io/primer/04-rubin-causal-model.html) of Preceptor's Primer. We reviewed a Preceptor Table, Population Table, Causal Effect, Simple Models (One tau & Two taus) and Assumptions (Validity, Stability, Representativeness, & Unconfoundedness). For further clarification of these concepts view [**Key Concepts**](https://ppbds.github.io/primer/glossary.html)
