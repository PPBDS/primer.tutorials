...
data_table <- tibble(ID = c("Student 1", "Student 2", "...", "Student 47", "Student 48",
...
precep_1 <- tibble(ID = c("Student 1", "Student 2", "...", "Student 47", "Student 48",
              "...", "Student 325", "Student 326", "...", "Student 670"),
       Heights = c("190", "160", "...", "172", "176", "...", "180", "162", "...", "185"),
...
<!-- But, we can provide lots of simple examples to make sure students understand the concepts. In other words: Here is a situation. Describe the Preceptor Table for this scenario. Or, here is a situation. Describe a reason why representativeness might not hold. We could go through three or four of these. Only in the first one would we confirm that students can define terms in their own words. Afterwards, we just walk through a new situtation, from start to finish.  -->
...
What is the average height of a student at New College of Florida? We have this data:

<!-- DK: When is this data from? -->
...
<!-- DK: Split into two separate questions. -->

Describe the *units* and *outcomes* in the Preceptor Table which would allow us to answer our question.

```{r preceptor-table-1-2}
question_text(NULL,
	message = "The 'units' refer to the rows, which are the individual students at New College. The 'outcome' refers to height, which is a column.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
```{r}
x_1 <- tibble(ID = c("Student 1", "Student 2", "...", "Student 47", "Student 48",
              "...", "Student 325", "Student 326", "...", "Student 670"),
       Heights = c("190", "160", "...", "172", "176", "...", "180", "162", "...", "185"))

x_2 <- tibble(ID = c("Student 11", "Student 32", "Student 47", "Student 68",
...
<!-- IS: Unsure of how to relate this section + exercise 8 to New College dataset. -->
...
<!-- DK: Remove this question. We never really make Population Tables. We just use them as a framework. -->
...
What are the three sources for the rows in the Population Table? 

<!-- DK: Remove: How are these rows usually indicated in the `Source` column? -->
...
<!-- DK: Ensure two or one sentence is what we do for all these questions. -->
...
<!-- DK: Use the knowledge drops from template_tutorial. -->
...
To answer these questions, we have made this Preceptor Table:
...
```{r causal-tables-1}
question_text(NULL,
	message = "The Preceptor Table will have a row for each individual Boston commuter. In addition to an ID column, it has 2 other columns: The outcome, which is attitude towards immigration, and the covariate, which is the treatment.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
<!-- DK: Mix up the assumptions you exam. Use unconfoundedness at least twice. -->
