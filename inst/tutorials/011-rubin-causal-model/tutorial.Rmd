...
# AP: model above never used (not deleted just in case)
```
...
<!-- DK: Check for junk. Do we use all the objects created above? I doubt it. -->

<!-- DK: Should those objects be created above or just run where they are shown? Probably the later . .  -->

<!-- AP: sorted through junk and followed instructions-->
