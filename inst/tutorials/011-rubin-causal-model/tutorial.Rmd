...
<!-- More detail on the Preceptor Table. How exactly does one construct one, step-by-step. Use the same approach as in the tempate tutorial. Maybe do that set of question 2 or 3 times, even time with a different example. How to make a Preceptor Table  was totally opaque to students this year, even after doing the tutorial. -->


<!-- Mihir: Change anything you want. First, get rid of mistakes/typos etc. Second, make substantive discussions consistent with later tutorials.

Take ownership of everything, making things consistent with our current best practices as described in the Cardinal Virtues appendix and in the template_tutorial.Rmd. -->
...
<!-- SD: Honestly, I feel like this tutorial is a bit too reliant on the textbook. Although it is very good, it still doesn't explain what the Cardinal Virtues are, but rather makes the student go back and look. Since it's the first tutorial, I feel that it should explain the Cardinal Virtues more and focus on teaching rather than assessing (in general) -->
...
<!-- SD: The line "But it is now 2024" should be removed as it just doesn't make sense to keep it (both grammatical and logical) -->
...
<!-- TJ: I think the wording in the instructions needs to be changed. The response is not one sentence -->
...
<!-- SD: It would be nice to add the Population Table somewhere here so that the students don't have to cycle back to the previous page to see it -->
...
<!-- AC: The symbols seem to be a bit messed up here; they're each on their own line. (Not fixed bc I don't know how to) -->
