...
Start a new pipe with our data by typing `police` followed by the `%>%` operator. On a new line,`select()` the `summary` column,`po_race`, `district_occurence`, and `investigative_findings`. We will first focus on the `summary` column, but will use the other columns later in this section. 
