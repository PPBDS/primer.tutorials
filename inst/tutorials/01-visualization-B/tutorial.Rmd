...
```{r mutate-3-hint, exercise = FALSE}
... %>% 
  mutate(age_scaled = ... / ...)
```
...
```{r mutate-4-hint, exercise = FALSE}
... %>% 
  mutate(att_change = ... - ...)
```
...
```{r mutate-5-hint, exercise = FALSE}
... %>% 
...
```{r mutate-6-hint, exercise = FALSE}
... %>% 
...
```{r mutate-7-hint, exercise = FALSE}
... %>% 
...
```{r mutate-8-hint, exercise = FALSE}
... %>% 
...
```{r mutate-9-hint, exercise = FALSE}
... %>% 
...
```{r mutate-10-hint, exercise = FALSE}
... %>% 
  group_by(democrat, ...) %>% 
  summarize(mean_change = mean(...), 
            max_change = max(...))
...
```{r mutate-11-hint, exercise = FALSE}
... %>% 
  group_by(democrat, ...) %>% 
  summarize(mean_change = mean(...), 
            max_change = max(...))
...
```{r mutate-12-hint, exercise = FALSE}
... %>% 
  arrange(mean_change)
...
```{r mutate-13-hint, exercise = FALSE}
... %>% 
  arrange(att_change)
...
```{r mutate-14-hint, exercise = FALSE}
... %>% 
  slice(1:5)
```
...
```{r mutate-15-hint, exercise = FALSE}
... %>% 
  ungroup() %>% 
  slice(1:5)
```
