...
First we need to load our data. Run `get_pums()`, setting the `variables` argument to `"PUMA"` and `"FINCP"`, the `state` to Illinois, `recode` to `TRUE`, the `survey` to `"acs1"`, and the year to 2019.
