...
<!-- DK: Not a great knowledge drop for this question. AP: ok, working on it -->
...
# fit_years
```
<!--AP: this was originally commented, is it supposed to be? -->
...
```
<!--AP: is this meant to be commented? -->
...
model <- lm(years_lived ~ age + won + year, data = your_data)
...
```{r}
predictions <- plot_predictions(fit_years, by = c("election_age", "sex"))

ggplot(predictions, aes(x = election_age, y = .pred, color = sex)) +
  geom_line() +
  labs(
    title = "Predicted Years Lived After Election by Age and Sex",
    subtitle = "Male and female candidates show different longevity patterns",
    caption = "Source: Longevity Returns to Political Office study data",
    x = "Age at Election",
