...
<!-- DK: What value of election_age do these predictions assume? -->
...
* The plot is a bit of a mess since it (poorly) combines the strong negative correlation we see for male candidates and the flat relationship for (the many fewer) female candidates.

I suspect that this awkward display is a bug in the **marginaleffects** package.
