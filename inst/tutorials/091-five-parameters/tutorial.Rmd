...
# Revisit some of this code. Do we really need all the coefficient stuff? 
# Is fit_all a good name?
...
<!-- Once you decide the appropriate replacement for `fit_years` and `candidates.qmd`, you can do a global replace to fix them all. -->
...
...
  select(last_name, ..., state, sex, ..., election_age, region)
```
