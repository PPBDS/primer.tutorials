...
dc_income <- read_rds("data/dc_income.rds") # See data/cleaning.R to see the data

us_median_age <- read_rds("data/us_median_age.rds") # Same as above

hennepin_race <- read_rds("data/hennepin_race.rds") # Same as above

dallas_bachelors <- read_rds("data/dallas_bachelors.rds") # Same as above
