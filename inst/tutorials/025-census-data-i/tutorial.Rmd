...
```{r}
get_acs(state = "Maine", geography = "county", variables = c((hhincome = "B19013_001"), year = 2021)) |>
...
<!-- MH: I have kept the years the same (for now), but this exercise always returns this error: Error: 5-year ACS support in tidycensus begins with the 2005-2009 5-year ACS. Consider using decennial Census data instead. -->
