...
<!-- MH: I will leave this section the same, it's good. -->
...
```{r eval = FALSE, include = FALSE, out.width = "1000"}
...
<!-- MH: `scale_fill_viridis_c` is not working for me -->
