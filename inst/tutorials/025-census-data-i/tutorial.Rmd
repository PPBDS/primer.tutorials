...
<!-- MH: Everything in this exercise works -->
### 
...
<!-- MH: Everything works in this section -->
...
### 
<!-- MH: I cannot get this one to work, I cannot find "P1_005N" anywhere, that's where it's breaking -->
...
<!-- MH: This works for 2020, need to update when data comes out -->
...
<!-- MH: Need to find 2021 equivalents for these (we can use 2021, that's not a decennial year, and we may as well use the most recent data) -->
...
<!-- MH: It works, need to update to 2021 data and find the table that is the same -->
...
<!-- MH: Need to find 2021 variable for this -->
...
Run `get_acs()` below setting `geography` = `"county"`, `variables` to `"B19013_001"`, `state` to `"GA"`, and `year` to `2020`
...
Run `get_acs()` below setting `geography` = `"tract"`, `variables` to `"B19013_001"`, `state` to `"13"`, `county` to `"Gwinnett"`, and `year` to `2020`
...
This variable works for every state
