...
<!-- GK: Remove your comments about typos. DONE -->
<!--     Add knowledge drops where they are missing. DONE -->
    <!-- Read Chapter 2. Start on Probability tutorial. Send me your answers.-->
...
<!-- GK: Add knowledge drop -->
When we are looking at a “category” of units — for instance, sex — we call this a covariate. Possible covariates include, but are not limited to, sex, age, political party and almost everything else which might be associated with attitudes toward immigration.
