...
```{r preceptor-table-1}
knitr::include_graphics("images/preceptor_img.png")
```

```{r preceptor-table-1-a}
question_text(NULL,
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
...
question_text(NULL,
    message = "The firs column 'ID' serves to label each unit. Each person and their height is a unit",
    answer(NULL, correct = TRUE),
    allow_retry = FALSE,
    incorrect = NULL,
    rows = 3)
