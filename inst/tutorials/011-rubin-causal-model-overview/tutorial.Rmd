...
<!-- Grammatical error, "used to indicate" instead of "used in indicate" -->
...
<!-- "between the data collection period and now" -->
...
<!-- "consider the two datasets as being drawn from the same population" instead of "to be drawn"-->
...
<!-- "of the most" instead of "all the most"-->
...
<!-- "combined table" should be in single form-->
...
<!-- One-sentence instead of one sentence -->
...
<!-- Should not start a sentence with "But" -->
...
<!-- As "But" should not be in the beginning of a sentence -> change to "However" -->
...
<!-- "the quantities", instead of just "quantities" -->
...
<!-- Consider changing the answer to "A potential outcome is what may happen to a unit of research in different scenarios" -->
...
<!-- Consider adding the intuition "representativeness indicates that the estimate drawn from our sample can represent for a larger population" -->
...
<!-- drop the comma between predictive models -->
...
<!-- I think it serves the purpose of practicing the formula -->
...
<!-- "control group" to single noun -->
<!-- Add "It is particularly useful" -->
