...
<<<<<<< HEAD
<!-- DK: I came across this warning: "plot_predictions(,,,, draw = FALSE) working fine interactively with a MASS:polr object but failing to refit the Hession when run in a tutorial." Please check whether or not this is an issue. AP: was working okay for me but I'll keep checking to see if it's an issue-->
=======
<!-- DK: I came across this warning: "plot_predictions(,,,, draw = FALSE) working fine interactively with a MASS:polr object but failing to refit the Hession when run in a tutorial." Please check whether or not this is an issue. AP: worked okay for me but I'll look into that -->
>>>>>>> master
...
<!-- DK: Add to template when you figure out these, so that future tutorial writers benefit. AP: done-->
...
<!-- Test takes too long to run. AP: Took about 17 seconds to run for me, I added a note at the top of the exercise-->
...
<!-- DK: No run code! Tell them what to type. AP: fixed in all -->
...
<!-- Test takes too long to run. AP: took 1 minute and 32 seconds to run for me, I added a note at the top of the exercise, will that be good enough or should i delete the exercise?-->
