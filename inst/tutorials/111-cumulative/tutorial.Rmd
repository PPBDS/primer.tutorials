...
<!-- DK: How do they phrase the approval_ch question? When do they ask it?  -->
...
<!-- DK: Discuss how this problem is more complex because the outcome variable is not a single number. It is five numbers. -->
...
<!-- DK: Repeat that the outcome is 5 numbers. Compare to the approve/not-approve binary outcome. -->
...
<!-- DK: This is too contestible a point to use in a knowledge drop. -->
...
<!-- DK: Drop family income and education. -->
...
<!-- DK: Add name. Add year. Add number of observations? -->

```{r wisdom-15}
question_text(NULL,
	message = "The Congressional XX is one of the largest political surveys in the United States. The data has how much people approve of the president as well as other useful variables such as ideology.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
