...
<!-- DK: Read the latest version of template tutorial. Done. -->

<!-- DK: Change this tutorial to match, exactly, the new version of the template. Done. -->

<!-- DK: Start experimenting with cool marginaleffects plots. Kind of confused, does this mean a completely new different type of model? or just plots as in using the model with ggplot, if so this is also done?-->
...
<!-- DK: Fix these levels. Done, tutorial was changed so that it wouldn't include things that don't exist in the tibble. -->
...
<!-- DK: The tutorial introduces a treatment in the context of ads earlier, but it should be clarified that the ads are not considered the treatment in the analysis. This clarification will help prevent confusion about the role of ads in the context of the exercise. Done.-->
...
<!-- DK: Some notes: MP: this was completed (there was a plot that was made) and I have created associated exercises following that as well-->
