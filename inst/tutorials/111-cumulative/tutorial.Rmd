...
<!-- Add question to load MASS. Change call to just polr. -->
...
<!-- DK: Move to this to QMD -> Console. -->

Continue the pipe with `tidy(conf.int = TRUE)`. This might take a minute or two.
...
<!-- DK: Explain need a new code chunk. Run this code in that chunk. Not an exercise code chunk. Use show_file(..., chunk = "Last")-->
...
<!-- DK: Too fast. Need tidy_approval object in QMD and console. Then show it to AI to make a table. -->
