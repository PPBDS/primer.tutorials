...
The data has 617,455 observations and 17 variables.
...
```{r the-question-5}
question_text(NULL,
	message = "We can manipulate the type of information about the president the people get, at least in theory, by showing people media that supports/doesn't support the current president.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Let's consider a *predictive* model. Which variable in `cces` do you think might have an important connection to `approval_ch`? (If you don't see a reasonable variable in the data, you can just name a variable which *might have been* included in the data.)

```{r the-question-6}
question_text(NULL,
	message = "The ideology of an individual could be connected to their approval of the president. Family income and education might have an important connection to approval_ch.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 2)
...
<!-- MK: Is this only for causal model? There is only one outcome for each individual unit with a predictive model but the answer below makes sense even though the unit is described to have two different outcomes. -->
...
```{r the-question-7}
question_text(NULL,
	message = "Some people might have a value for ideology of Very Liberal. Others might have a value of Very Conservative. Those two groups might, on average, have different values for the outcome variable.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
People who are liberal are more likely to approve liberal presidents and people who are conservative are more likely to approve conservative presidents.
...
```{r the-question-8}
question_text(NULL,
	message = "What is the relationship between the approval of the presdent to ideology, family income, and education?",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
```{r the-question-9}
question_text(NULL,
	message = "approval_ch is important because it holds the value of the individual's approval of the current president.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
