...
<!-- MK: Is this correct or should I add more variables? -->
...
<!-- MK: do the answers and the knowledge drops make sense. -->
...
```{r courage-13}
question_text(NULL,
	message = "When comparing (only) high school graduates with people who are in other education categories, high school graduates have a -0.34 value for approval, meaning that they are less likely to have more approval for the president, relative to the intercept, which for education is no high school.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
```{r courage-15}
question_text(NULL,
	message = "If we compare people who are very conservative with the intercept, the very conservative people have, on average, a 6.23 more approval toward the president, adjusting for other individual characteristics.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
# MK: What should the graph look like, I can't seem to fit all 4 variables in 1 graph without makeing it too hard to read. I have excluded faminc for this graph. 
