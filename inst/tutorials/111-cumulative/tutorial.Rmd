...
Imagine you’re a pollster preparing for the upcoming election. You dig into 2020 approval ratings, noticing that support for Trump declined most among certain education levels. As correlations between education and approval emerge, you begin to rethink your polling strategy—how to target messages, where to focus outreach. The data offers clues, but it also raises new questions. There are many decisions to make.
