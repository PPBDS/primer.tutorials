...
```{r temperance-51, exercise = TRUE}
comparisons(fit_approval, variable = "ideology")
```

```{r temperance-51-hint-2, eval = FALSE}
comparisons(fit_approval, variable = "ideology")
```

```{r temperance-51-test, include = FALSE}
comparisons(fit_approval, variable = "ideology")
```
...
```{r temperance-52, exercise = TRUE}
avg_comparisons(fit_approval, variable = "ideology")
```

```{r temperance-52-hint-3, eval = FALSE}
avg_comparisons(fit_approval, variable = "ideology")
```

```{r temperance-52-test, include = FALSE}
avg_comparisons(fit_approval, variable = "ideology")
```
...
```{r temperance-53, exercise = TRUE}
plot_predictions(fit_approval, condition = "ideology")
```

```{r temperance-53-hint-4, eval = FALSE}
plot_predictions(fit_approval, condition = "ideology")
```

```{r temperance-53-test, include = FALSE}
plot_predictions(fit_approval, condition = "ideology")
```
