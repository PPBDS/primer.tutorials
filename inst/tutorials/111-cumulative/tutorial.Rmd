...
```{r the-question-5}
question_text(NULL,
	message = "Consider positive Facebook ads as a treatment. We might expose some people to those adds and not others. Then, we can measure the causal effect of ads on presidential approval.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
```{r the-question-8}
question_text(NULL,
	message = "What is the relationship between the approval of the presdent and an individual's ideology, family income, and education?",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
```{r the-question-9}
question_text(NULL,
	message = "XX: What simple ndata object will you use to answer it?",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
