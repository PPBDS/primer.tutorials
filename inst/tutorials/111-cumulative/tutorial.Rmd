...
Pipe `fit_approve` to `add_predicted_draws()` with the argument `newdata = ndata`. Then continue the pipe with `filter(.prediction %in% c("Strongly Approve", "Strongly Disapprove"))`
