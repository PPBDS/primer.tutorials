...
Interpretation: plot_predictions is showing the probability of approval ratings. We can see that as we progress in education levels. It might seem confusing but each point represents the given probability that someone with no education level would have an approval rating for.
