...
ndata <- expand_grid(c("Very Liberal",
                       "Liberal, Moderate",
                       "Conservative",
                       "Very Conservative",
                       "Not Sure"),
...
```{r temperance-3}
question_text(NULL,
	message = "We will inclue ideology and education.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
We saw from the `fit_approve` that `faminc` does not have any relationship with `approval` so we will not be including it in our `newdata` object.
...
```{r temperance-4}
question_text(NULL,
	message = "The ideology would have all of the political ideologies listed in the data, this is Very Liberal, Liberal, Moderate, Conservative, Very Conservative, and Not Sure. Education will have all of the education leves: No HS, High School Graduate, Some College, 2-Year, 4-Year, and Post-Grad.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Here is the R code which creates the `newdata` object: `expand_grid(c("Very Liberal", "Liberal, Moderate", "Conservative", "Very Conservative", "Not Sure"), c("No HS", "High School Graduate", "Some College", "2-Year", "4-Year", "Post-Grad"))`. Type it into the code exercise block and hit "Run Code."
