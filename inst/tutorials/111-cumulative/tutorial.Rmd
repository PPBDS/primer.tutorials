...
<!-- DK: I came across this warning: "plot_predictions(,,,, draw = FALSE) working fine interactively with a MASS:polr object but failing to refit the Hession when run in a tutorial." Please check whether or not this is an issue. -->
...
<!-- DK: No run code! Tell them what to type.  -->

Hit "Run Code." Note that this may take a minute or two to run.
