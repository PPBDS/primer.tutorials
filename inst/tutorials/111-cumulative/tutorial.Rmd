...
<!-- DK: The below plot is not working because plot_predictions() uses different variable names for its output than what the previous code did, so there is no "predicted" variable.  -->
...
<!--AP: is this needed? Make it like the template. -->
