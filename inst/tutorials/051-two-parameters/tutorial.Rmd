...
Render `analysis.qmd`. This should show the default things in the file. Make sure the name of the file and the author is correct. 
...
To learn more about **gtsummary**, type `?gtsummary` in the console, this will open up a description page. Make sure to load the **gtsummary** package first. 
...
The output in the `analysis.qmd` preview should have the same table from the previous question. Again, this table provides an important summary of the data we are working with. 
