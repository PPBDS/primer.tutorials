...
```{r justice-7}
question_text(NULL,
	message = "Since the Preceptor Table only contains height for all adult males on Earth, it does not represent the larger population that also includes everyone regardless of their age and sex.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
