...
"lm" is the default value, there are also other engines. Type `?linear_reg` in the Console for more information.
...
Note that a 0/1 dummy variable `sexMale` was created because it is a categorical variable in the model. 
...
<!-- GK: Maybe need rewrite? Not sure how to fix-->
...
Write a sentence interpreting the 159 estimate for the Intercept.

```{r courage-11}
question_text(NULL,
	message = "Our (best) guess/estimate as to the average height of all adult females in the population is 159 centimeters.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Write a sentence interpreting the 18 estimate for the sexMale.

```{r courage-12}
question_text(NULL,
	message = "When comparing the average height of men versus women, our guess/ estimate is that men is taller than women by 18 centimeters.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
