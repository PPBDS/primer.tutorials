...
<!-- DK: Follow these instructions from the template. XX: Consider showing your table, and the code which you used to create it. For you, make it a very simple table, simple as possible, probably only using kable, from knitr. But you need a title, subtitle and caption, or the equivalent. -->
