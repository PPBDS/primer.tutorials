...
> *What is the average height of men and women? How big is the difference?*

This simple question helps us use data to compare groups and make more informed decisions in areas like health, design, and policy.

<!-- DK: See new discussion in the template_tutorial about what goes here. STILL WRONG. Review the template_tutorial, especially the parts about interpreting parameters. Also the cardinal virtues. -->
...
<!-- DK: Interpretation questions. at least three. One, the estimate. Second, the confidence interval. -->
...
The model predicts an average height of **175 cm for men** and **161 cm for women**, with 95% confidence intervals of **173–177 cm** and **159–163 cm**, meaning we’re fairly certain the true averages fall within these ranges.

### Exercise 5

<!-- DK: Test in exercise code chunk! -->
...
<!-- DK: Who cares about numbers? -->

The model predicts that men are on average 13.8 cm taller than women, with a 95% confidence interval from 10.8 to 16.7 cm. This difference is statistically significant.
...
This tells you how much taller men are on average compared to women, using a ratio instead of a difference. A value of 1.09 means men are about 9% taller on average.
...
Add `*Rproj` to the `.gitignore` file. You don't want your personal Rpubs details stored in the clear on Github. Commit/push everything.
