...
<!-- Added text -->
**Good data science starts with clarity: what do you want to know, and why?**  
...
<!-- Added text -->
**Keep this in mind when interpreting your results: the dataset is adjusted to better represent minorities, so overall averages might differ from raw population statistics.**  

### Exercise 4

Why might the average height in this dataset be different from the *true* average height of all people? In 1-2 sentences, explain why the average height calculated from this data might not exactly match the average height of everyone in the US.

###

```{r the-question-4}
question_text(NULL,
	message = "The data does not include everyone equally. Some groups are counted more than others, so the average might not match the real average for all people.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
