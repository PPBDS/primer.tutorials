...
<!-- DK: Add as you see fit: -->

<!--   labs(title = "Average Height in Men and Women", -->
<!--        subtitle = "", -->
<!--        x = NULL, -->
<!--        y = "Height in cm", -->
<!--        caption = "Date from a sample of 100 individuals from NHANES") -->

### 

<!-- DK: New question. Use plot_comparisons to get a good estimate of the height difference between men and women, and the confidence interval thereof. -->
