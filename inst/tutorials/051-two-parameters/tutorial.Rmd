...
<!-- DK: this part is not in template, is it needed? Do. Delete. DONE! -->
...
<!-- DK: See new discussion in the template_tutorial about what goes here. -->
...
In a few sentences, choose two different values for the imaginary treatment variable `vitamin` for one unit. Then, guess what the potential outcomes would be for each value, and use those guesses to determine the causal effect for that unit. For example, how might vitamins affect `height`?
...
The Preceptor Table does not include every covariate you will eventually include in your model, only the covariates which you need to answer your question.
...
Again, make the plot looks more professional by adding a title, subtitle, caption, and labels. Remember this is what your graph should look like.
...
<!-- AP: What label should we have instead? -->
