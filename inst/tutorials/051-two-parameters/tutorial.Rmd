...
```{r temperance-4}
question_text(NULL,
	message = "Each row in the object will contain the height of an adult male.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
We will create a plot that displays the posterior probability distribution of the predicted height for each adult male. 
...
Behind the scenes, we have created the `ndata` object using this code. Type `ndata` and hit "Run Code." This should result in the same thing as `newdata`.
...
Each row represents the predicted height for an adult male, all of which form the posterior probability distribution for the height of an adult male. We will turn them into a graph for better illustration. 
