...
In this tutorial, we will use `predictions()`, `avg_comparisons()`, and `plot_comparisons()` from the **`marginaleffects`** package. `predictions()` computes model predictions, `avg_comparisons()` estimates average effects of variable changes, and `plot_comparisons()` visualizes these effects with confidence intervals.
<!-- AP: Is this how it should be? -->
...
<!-- DK: Place here three easier marginal effects questions, as listed above. -->
