...
question_text(NULL,
	...
	allow_retry = TRUE, try_again_button = "Edit Answer",
	incorrect = NULL,
	rows = 6)
```
...
<!-- DK: make clearer. tell what to do. -->
...
Update the `analysis.qmd` file. Copy the code from above and put it in the qmd file. Save the file and in the Console, run: 
