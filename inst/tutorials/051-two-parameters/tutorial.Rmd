...
answer <- paste("When comparing the average height of men versus women, our guess/estimate is that men are taller than women by", key_number, "centimeters on average.")
```
