...
In the code chunk below, run `tidy()` on `fit_height` with the argument `conf.int` set equal to `TRUE`. The returns 95% intervals for all the parameters in our model.
