...
<!-- DK: Make like template. -->

Create a new code chunk in `analysis.qmd`. Add the code chunk option: `cache: true`. Copy/paste the code from above for estimating the model into the code chunk, assigning the result to `fit_height`.
