...
<!-- DK: Investigate why we need all this on the same line. Annoying! -->

Assign the provided HTML to a variable named `raw_html_2`. (You may need to put everything on a single line.)
