...
question_text(NULL,
    ...
    #You would average $Y_c(u)$ for females and subtract that from the average $Y_t(u)$ for females
    #which is better?
    answer(NULL, correct = TRUE),
    allow_retry = FALSE,
    incorrect = NULL,
...
# This explanation could be made more clear and also needs to be added to the primer
    answer(NULL, correct = TRUE),
    allow_retry = FALSE,
    incorrect = NULL,
    options = list(nrows = 2))
...
question_text(NULL,
    ...
    #This is not explicitly stated in primer
    answer(NULL, correct = TRUE),
    allow_retry = FALSE,
    incorrect = NULL,
    options = list(nrows = 2))
...
question_text(NULL,
    message = "1.6",
#think of a way to make this a non decimal answer without screwing up the other questions
    answer(NULL, correct = TRUE),
    allow_retry = FALSE,
    incorrect = NULL,
    options = list(nrows = 2))
