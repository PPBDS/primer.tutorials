...
# write_rds(imf_raw, file = "data/03-data-imf.rds")

imf_raw <- read_rds("data/03-data-imf.rds")
...
<!-- ```{r the-international-mo-1, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-1-hint-1, eval = FALSE} -->
<!-- library(imfr) -->
<!-- ``` -->
...
<!-- ```{r the-international-mo-2, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-2-hint-1, eval = FALSE} -->
<!-- help(package = "imfr") -->
<!-- ``` -->
...
<!-- ```{r the-international-mo-3, exercise = TRUE} -->
...
<!-- ```{r the-international-mo-4, exercise = TRUE} -->
...
<!-- ```{r the-international-mo-5, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-5-hint-1, eval = FALSE} -->
<!-- imf_ids() -->
<!-- ``` -->
...
<!-- ```{r the-international-mo-6, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-6-hint-1, eval = FALSE} -->
<!-- imf_ids("HPDD") -->
<!-- ``` -->
...
<!-- ```{r the-international-mo-7, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-7-hint-1, eval = FALSE} -->
...
<!-- ```{r the-international-mo-8, exercise = TRUE, exercise.timelimit = 600} -->

<!-- ``` -->

<!-- ```{r the-international-mo-8-hint-1, eval = FALSE} -->
...
<!-- ```{r the-international-mo-9, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-9-hint-1, eval = FALSE} -->
<!-- imf_raw |>  -->
<!--   arrange(desc(...)) -->
<!-- ``` -->
...
<!-- ```{r the-international-mo-10, exercise = TRUE} -->
...
<!-- ```{r the-international-mo-11, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-11-hint-1, eval = FALSE} -->
<!-- codelist -->
<!-- ``` -->
...
<!-- ```{r the-international-mo-12, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-12-hint-1, eval = FALSE} -->
<!-- iso_codes <- codelist |>  -->
<!--   select(..., ...) -->
<!-- ``` -->
...
<!-- ```{r the-international-mo-13, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-13-hint-1, eval = FALSE} -->
...
<!-- ```{r the-international-mo-14, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-14-hint-1, eval = FALSE} -->
<!-- Remember that we use the $ operator to extract a column as a vector. -->
<!-- ``` -->

<!-- ```{r the-international-mo-14-hint-2, eval = FALSE} -->
...
<!-- ```{r the-international-mo-15, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-15-hint-1, eval = FALSE} -->
...
<!-- ```{r the-international-mo-16, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-16-hint-1, eval = FALSE} -->
<!-- ... |>  -->
<!-- rename(... = `GGXWDG_GDP`) -->
<!-- ``` -->
...
<!-- ```{r the-international-mo-17, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-17-hint-1, eval = FALSE} -->
<!-- ... |>  -->
<!--   filter(year == "2015") -->
<!-- ``` -->
...
<!-- ```{r the-international-mo-18, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-18-hint-1, eval = FALSE} -->
<!-- ... |>  -->
<!--   arrange(desc(dtg)) |>  -->
<!--   slice(1:15) -->
<!-- ``` -->
...
<!-- ```{r the-international-mo-19, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-19-hint-1, eval = FALSE} -->
<!-- ... |>  -->
...
<!-- ```{r the-international-mo-20, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-20-hint-1, eval = FALSE} -->
<!-- ... + -->
...
<!-- ```{r the-international-mo-21, exercise = TRUE} -->

<!-- ``` -->

<!-- ```{r the-international-mo-21-hint-1, eval = FALSE} -->
<!-- ... + -->
<!--   labs(..., -->
<!--        y = "" -->
<!--        ...) -->
...
```{r bison-with-package-1, exercise = TRUE}

```

```{r bison-with-package-1-hint-1, eval = FALSE}
library(rbsion)
```
...
```{r bison-with-package-2, exercise = TRUE}

```

```{r bison-with-package-2-hint-1, eval = FALSE}
help(package = "rbison")
```
...
Run `bison`. Set the argument `species` equal to "Accipiter" and set `type` to "scientific_name". Set count to `500`. Save the output to a file named 
`output`.

```{r bison-with-package-3, exercise = TRUE}

```

```{r bison-with-package-3-hint-1, eval = FALSE}
...
```{r bison-with-package-4, exercise = TRUE}

```

```{r bison-with-package-4-hint-1, eval = FALSE}
str(output)
```
...
```{r bison-with-package-5, exercise = TRUE}


```

```{r bison-with-package-5-hint-1, eval = FALSE}
class(output)
```
...
```{r bison-with-package-6, exercise = TRUE}


```

```{r bison-with-package-6-hint-1, eval = FALSE}
output$counties
```
...
```{r bison-with-package-7, exercise = TRUE}

```

```{r bison-with-package-7-hint-1, eval = FALSE}
bisonmap(input = ..., geom = ...)
```
...
```{r bison-with-package-8, exercise = TRUE}

```

```{r bison-with-package-8-hint-1, eval = FALSE}
...
```{r bison-with-get-1, exercise = TRUE}

```

```{r bison-with-get-1-hint-1, eval = FALSE}
GET(url = bison_base)
```
...
```{r bison-with-get-2, exercise = TRUE}

```

```{r bison-with-get-2-hint-1, eval = FALSE}
bison_response <- GET(url = "https://bison.usgs.gov/api/search.json",
    query = list(species = "...",
                 type = "...", 
                 count = 500))
...
```{r bison-with-get-3, exercise = TRUE}

```

```{r bison-with-get-3-hint-1, eval = FALSE}
...
```{r bison-with-get-4, exercise = TRUE}

```

```{r bison-with-get-4-hint-1, eval = FALSE}
content(response) |> 
  fromJSON()
```
...
```{r bison-with-get-5, exercise = TRUE}

```

```{r bison-with-get-5-hint-1, eval = FALSE}
...
```{r bison-with-get-6, exercise = TRUE}

```

```{r bison-with-get-6-hint-1, eval = FALSE}
str(output_api)
```
...
```{r bison-with-get-7, exercise = TRUE}

```

```{r bison-with-get-7-hint-1, eval = FALSE}
str(output_api)
```
...
```{r bison-with-get-8, exercise = TRUE}

```

```{r bison-with-get-8-hint-1, eval = FALSE}
str(output_api)
```
...
```{r bison-with-get-9, exercise = TRUE}

```

```{r bison-with-get-9-hint-1, eval = FALSE}
... |> 
mutate(across(everything(), as.character))
```
...
```{r bison-with-get-10, exercise = TRUE}

```

```{r bison-with-get-10-hint-1, eval = FALSE}
... |> 
  mutate(names = c("total", "fips"))
```
...
```{r bison-with-get-11, exercise = TRUE}

```

```{r bison-with-get-11-hint-1, eval = FALSE}
... |> 
...
Continue your pipe. Use `pivot_wider()` to transform the data so that values for `total` and `fips` have individual columns. Set `names_from` equal to `names` and `values_from` equal to `values`. 

```{r bison-with-get-12, exercise = TRUE}

```

```{r bison-with-get-12-hint-1, eval = FALSE}
... |> 
...
```{r bison-with-get-13, exercise = TRUE}

```

```{r bison-with-get-13-hint-1, eval = FALSE}
... |> 
...
```{r bison-with-get-14, exercise = TRUE}

```

```{r bison-with-get-14-hint-1, eval = FALSE}
... |> 
...
```{r bison-with-get-15, exercise = TRUE}

```

```{r bison-with-get-15-hint-1, eval = FALSE}
...
```{r bison-with-get-16, exercise = TRUE}

```

```{r bison-with-get-16-hint-1, eval = FALSE}
  map_data("state")
```
...
```{r bison-with-get-17, exercise = TRUE}

```

```{r bison-with-get-17-hint-1, eval = FALSE}
  map_data("state") |> 
  left_join("...", by = "region")
```
...
```{r bison-with-get-18, exercise = TRUE}

```

```{r bison-with-get-18-hint-1, eval = FALSE}
... |> 
  ggplot(aes(long, lat, group = group, fill = total)) +
  geom_polygon() 
```
...
```{r bison-with-get-19, exercise = TRUE}

```

```{r bison-with-get-19-hint-1, eval = FALSE}
...
  ggplot(aes(long, lat, group = group, fill = total)) +
  geom_polygon() 
```
...
```{r bison-with-get-20, exercise = TRUE}

```

```{r bison-with-get-20-hint-1, eval = FALSE}
... + 
  labs(title = "...", 
       ...)
```
