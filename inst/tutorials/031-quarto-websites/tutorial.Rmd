...
<!-- Many of the images her are not helpful. First, they don't show enough of the _quarto.yml file. Second, they could just be replaced with copy/pasted text surrounded by simple triple backticks. Copy/pasted is much easier to maintain! -->
...
Commit all the files. Note how the "push" button is greyed out. This is because we have not connected the project to Github. There is no where to "push" the code to.
