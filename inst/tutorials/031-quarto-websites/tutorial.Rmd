...
The material bracketed by the three dashes at the very top is called a **YAML Header**. These are very sensitive about all sorts of subtle formatting issues.
...
Create a new code chunk and load two libraries: **tidyverse** and **ggtheme**.
...
As you build the website, we will ask you to share the updated files, using Terminal commands like `head`, `tail` and `cat`. 
