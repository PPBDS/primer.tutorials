...
Though an R script will use the libraries you already have loaded if executed interactively, it is good practice to include these at the top of the script. Any script you create should run correctly, even if you have just re-started R.
